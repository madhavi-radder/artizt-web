...
!(function (t, e) {
                ...
                for (let a = o.length; a--; )
                  if (o[a] === r)
                    return (s.delegateTarget = r), n.oneOff &&
                      j.off (t, s.type, e, i), i.apply (r, [s]);
              return null;
            };
          }) (t, i, n)
        : (function (t, e) {
  ...
  class B {
    ...
    dispose () {
      H.remove (
        this._element,
        this.constructor.DATA_KEY
      ), j.off (this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames (
        this
      ).forEach (t => {
        this[t] = null;
      });
  ...
  const U = {
    ...
    getDataAttributes (t) {
      ...
      return Object.keys (t.dataset)
        ...
        .forEach (i => {
          let n = i.replace (/^bs/, '');
          (n = n.charAt (0).toLowerCase () + n.slice (1, n.length)), (e[n] = q (
            t.dataset[i]
          ));
        }), e;
    },
  ...
  class st extends B {
    constructor (t, e) {
      super (
        t
      ), (this._items = null), (this._interval = null), (this._activeElement = null), (this._isPaused = !1), (this._isSliding = !1), (this.touchTimeout = null), (this.touchStartX = 0), (this.touchDeltaX = 0), (this._config = this._getConfig (e)), (this._indicatorsElement = V.findOne ('.carousel-indicators', this._element)), (this._touchSupported = 'ontouchstart' in document.documentElement || navigator.maxTouchPoints > 0), (this._pointerEvent = Boolean (window.PointerEvent)), this._addEventListeners ();
    }
    static get Default () {
      return X;
    }
    ...
    pause (t) {
      t ||
        (this._isPaused = !0), V.findOne ('.carousel-item-next, .carousel-item-prev', this._element) && (s (this._element), this.cycle (!0)), clearInterval (this._interval), (this._interval = null);
    }
    cycle (t) {
      t ||
    ...
    _addEventListeners () {
      this._config.keyboard &&
        j.on (this._element, 'keydown.bs.carousel', t =>
          this._keydown (t)
        ), 'hover' === this._config.pause && (j.on (this._element, 'mouseenter.bs.carousel', t => this.pause (t)), j.on (this._element, 'mouseleave.bs.carousel', t => this.cycle (t))), this._config.touch && this._touchSupported && this._addTouchEventListeners ();
    }
    ...
    _slide (t, e) {
      ...
      if (this._element.classList.contains ('slide')) {
        ...
        const t = () => {
          o.classList.remove (c, h), o.classList.add (it), n.classList.remove (
            it,
            h,
            c
    ...
    static dataApiClickHandler (t) {
      ...
      s &&
        (i.interval = !1), st.carouselInterface (e, i), s && st.getInstance (e).to (s), t.preventDefault ();
    }
  }
  j.on (
    document,
  ...
  class pt extends B {
    ...
    show () {
      ...
      if (j.trigger (this._element, 'show.bs.collapse').defaultPrevented)
        return;
      e.forEach (e => {
        i !== e && pt.getOrCreateInstance (e, {toggle: !1}).hide (), t ||
          H.set (e, 'bs.collapse', null);
      });
      const n = this._getDimension ();
      this._element.classList.remove (
        ct
      ), this._element.classList.add (ht), (this._element.style[n] = 0), this._addAriaAndCollapsedClass (this._triggerArray, !0), (this._isTransitioning = !0);
    ...
    hide () {
      ...
      (this._element.style[
        t
      ] = `${this._element.getBoundingClientRect ()[t]}px`), u (this._element), this._element.classList.add (ht), this._element.classList.remove (ct, lt);
      ...
      (this._isTransitioning = !0), (this._element.style[t] = ''), this._queueCallback (
        () => {
          (this._isTransitioning = !1), this._element.classList.remove (
            ht
          ), this._element.classList.add (ct), j.trigger (
            this._element,
            'hidden.bs.collapse'
          );
        },
  ...
  function de (t) {
    ...
    if (c) {
      ...
      w === Wt (i) &&
        ...
        'absolute' === a &&
        ((E = 'scrollHeight'), (A = 'scrollWidth')), (w = w), (s !== mt &&
        ((s !== bt && s !== _t) || o !== Et)) ||
        ((v = gt), (m -= w[E] - n.height), (m *= l ? 1 : -1)), (s !== bt &&
        ((s !== mt && s !== gt) || o !== Et)) ||
    ...
    return e === Tt
      ? Te (
          (function (t) {
            ...
            return n &&
              ((s = n.width), (o =
                n.height), /^((?!chrome|android).)*safari/i.test (
                navigator.userAgent
        ...
        var n = 'clippingParents' === e
          ...
          r = s.reduce (function (e, i) {
            ...
            return (e.top = ie (
              n.top,
              e.top
            )), (e.right = ne (n.right, e.right)), (e.bottom = ne (n.bottom, e.bottom)), (e.left = ie (n.left, e.left)), e;
          }, Oe (t, o));
    ...
    fn: function (t) {
      ...
      if (!e.modifiersData[n]._skip) {
        for (
          ...
          if (
            (o && P.push (S[k] <= 0), a &&
              P.push (S[N] <= 0, S[I] <= 0), P.every (function (t) {
              return t;
            }))
          ) {
            (T = C), (A = !1);
  ...
  class hi extends B {
    ...
    show () {
      ...
      this._inNavbar
        ...
        : this._createPopper (
            e
          ), 'ontouchstart' in document.documentElement && !e.closest ('.navbar-nav') && [].concat (...document.body.children).forEach (t => j.on (t, 'mouseover', d)), this._element.focus (), this._element.setAttribute ('aria-expanded', !0), this._menu.classList.add (Je), this._element.classList.add (Je), j.trigger (this._element, 'shown.bs.dropdown', t);
    }
    hide () {
      if (c (this._element) || !this._isShown (this._menu)) return;
      const t = {relatedTarget: this._element};
    ...
    _getConfig (t) {
      if (
        ((t = {
          ...
          ...U.getDataAttributes (this._element),
          ...t,
        }), a (Ue, t, this.constructor.DefaultType), 'object' ==
          typeof t.reference &&
          !o (t.reference) &&
  ...
  ), j.on (document, Ze, ei, hi.dataApiKeydownHandler), j.on (document, Ge, hi.clearMenus), j.on (document, 'keyup.bs.dropdown.data-api', hi.clearMenus), j.on (
    document,
    Ge,
    ti,
    function (t) {
  ...
  class fi {
    ...
    reset () {
      this._resetElementAttributes (
        this._element,
        'overflow'
      ), this._resetElementAttributes (this._element, 'paddingRight'), this._resetElementAttributes (di, 'paddingRight'), this._resetElementAttributes (ui, 'marginRight');
    }
    ...
    show (t) {
      this._config.isVisible
        ? (this._append (), this._config.isAnimated &&
            u (this._getElement ()), this._getElement ().classList.add (
            gi
  ...
  class Hi extends B {
    constructor (t, e) {
      super (
        t
      ), (this._config = this._getConfig (e)), (this._dialog = V.findOne ('.modal-dialog', this._element)), (this._backdrop = this._initializeBackDrop ()), (this._focustrap = this._initializeFocusTrap ()), (this._isShown = !1), (this._ignoreBackdropClick = !1), (this._isTransitioning = !1), (this._scrollBar = new fi ());
    }
    static get Default () {
      return Ci;
    }
    ...
    show (t) {
      this._isShown ||
        ...
        ((this._isShown = !0), this._isAnimated () &&
          ...
          Pi
        ), this._adjustDialog (), this._setEscapeEvent (), this._setResizeEvent (), j.on (
          this._dialog,
          Ii,
          () => {
    ...
    hide () {
      ...
      t &&
        (this._isTransitioning = !0), this._setEscapeEvent (), this._setResizeEvent (), this._focustrap.deactivate (), this._element.classList.remove (ji), j.off (this._element, Si), j.off (this._dialog, Ii), this._queueCallback (() => this._hideModal (), this._element, t);
    }
    dispose () {
    ...
    _showElement (t) {
      ...
      (this._element.parentNode &&
        ...
        document.body.append (
          this._element
        ), (this._element.style.display = 'block'), this._element.removeAttribute ('aria-hidden'), this._element.setAttribute ('aria-modal', !0), this._element.setAttribute ('role', 'dialog'), (this._element.scrollTop = 0), i && (i.scrollTop = 0), e && u (this._element), this._element.classList.add (ji), this._queueCallback (
        () => {
          this._config.focus &&
            this._focustrap.activate (), (this._isTransitioning = !1), j.trigger (
            this._element,
            'shown.bs.modal',
            {relatedTarget: t}
          );
      ...
      (this._element.style.display =
        ...
        () => {
          document.body.classList.remove (
            Pi
          ), this._resetAdjustments (), this._scrollBar.reset (), j.trigger (
            this._element,
            Li
          );
        }
    ...
    _adjustDialog () {
      const t =
        ...
        i = e > 0;
      ((!i && t && !m ()) || (i && !t && m ())) &&
        (this._element.style.paddingLeft = `${e}px`), ((i && !t && !m ()) || (!i && t && m ())) && (this._element.style.paddingRight = `${e}px`);
    }
    _resetAdjustments () {
    ...
    show (t) {
      this._isShown ||
        ...
        ((this._isShown = !0), (this._element.style.visibility =
          ...
          new fi ().hide (), this._element.removeAttribute (
          'aria-hidden'
        ), this._element.setAttribute (
          'aria-modal',
          !0
          ...
          () => {
            this._config.scroll || this._focustrap.activate (), j.trigger (
              this._element,
              'shown.bs.offcanvas',
              {relatedTarget: t}
            );
    ...
    hide () {
      this._isShown &&
        (j.trigger (this._element, 'hide.bs.offcanvas').defaultPrevented ||
          (this._focustrap.deactivate (), this._element.blur (), (this._isShown = !1), this._element.classList.remove (
            $i
  ...
  j.on (
    ...
    function (t) {
      ...
      i && i !== e && Fi.getInstance (i).hide (), Fi.getOrCreateInstance (
        e
      ).toggle (this);
    }
  ...
  class un extends B {
    ...
    dispose () {
      clearTimeout (
        this._timeout
      ), j.off (this._element.closest (ln), cn, this._hideModalHandler), this.tip && this.tip.remove (), this._disposePopper (), super.dispose ();
    }
    show () {
      ...
      n.setAttribute (
        'id',
        s
      ), this._element.setAttribute ('aria-describedby', s), this._config.animation && n.classList.add (nn);
      ...
      H.set (
        ...
        this.constructor.DATA_KEY,
        this
      ), this._element.ownerDocument.documentElement.contains (this.tip) || (a.append (n), j.trigger (this._element, this.constructor.Event.INSERTED)), this._popper ? this._popper.update () : (this._popper = qe (this._element, n, this._getPopperConfig (r))), n.classList.add (sn);
      const l = this._resolvePossibleFunction (this._config.customClass);
      l && n.classList.add (...l.split (' ')), 'ontouchstart' in
      ...
      this._queueCallback (
        () => {
          ...
          (this._hoverState = null), j.trigger (
            this._element,
    ...
    hide () {
      ...
      t.classList.remove (
        sn
      ), 'ontouchstart' in document.documentElement && [].concat (...document.body.children).forEach (t => j.off (t, 'mouseover', d)), (this._activeTrigger.click = !1), (this._activeTrigger.focus = !1), (this._activeTrigger.hover = !1);
    ...
    getTipElement () {
      ...
      return this.setContent (
        e
      ), e.classList.remove (nn, sn), (this.tip = e), this.tip;
    }
    setContent (t) {
    ...
    _enter (t, e) {
      (e = this._initializeOnDelegatedTarget (
        t,
        e
      )), t && (e._activeTrigger['focusin' === t.type ? dn : hn] = !0), e
        .getTipElement ()
        .classList.contains (sn) || e._hoverState === on
        ? (e._hoverState = on)
        : (clearTimeout (e._timeout), (e._hoverState = on), e._config.delay &&
    ...
    _leave (t, e) {
      (e = this._initializeOnDelegatedTarget (
        t,
        e
      )), t && (e._activeTrigger['focusout' === t.type ? dn : hn] = e._element.contains (t.relatedTarget)), e._isWithActiveTrigger () ||
        (clearTimeout (e._timeout), (e._hoverState = rn), e._config.delay &&
  ...
  class An extends B {
    constructor (t, e) {
      super (
        t
      ), (this._scrollElement = 'BODY' === this._element.tagName ? window : this._element), (this._config = this._getConfig (e)), (this._offsets = []), (this._targets = []), (this._activeTarget = null), (this._scrollHeight = 0), j.on (this._scrollElement, 'scroll.bs.scrollspy', () => this._process ()), this.refresh (), this._process ();
    }
    static get Default () {
      return bn;
    }
    ...
    refresh () {
      ...
      (this._offsets = []), (this._targets = []), (this._scrollHeight = this._getScrollHeight ()), V.find (
        wn,
        this._config.target
      )
        .map (t => {
    ...
    _getConfig (t) {
      return ((t = {
        ...
        r (t.target) || document.documentElement), a (_n, t, vn), t;
    }
    _getScrollTop () {
    ...
    _activate (t) {
      ...
      i.classList.add (yn), i.classList.contains ('dropdown-item')
        ? V.findOne (
            '.dropdown-toggle',
            i.closest ('.dropdown')
          ).classList.add (yn)
  ...
  class xn extends B {
    ...
    _transitionComplete (t, e, i) {
      ...
      t.classList.add (
        Tn
      ), 'tab' === t.getAttribute ('role') && t.setAttribute ('aria-selected', !0), u (t), t.classList.contains (On) && t.classList.add (Cn);
      let n = t.parentNode;
      if (
  ...
  class Mn extends B {
    ...
    show () {
      j.trigger (this._element, 'show.bs.toast').defaultPrevented ||
        (this._clearTimeout (), this._config.animation &&
          ...
          Sn
        ), u (this._element), this._element.classList.add (
          Nn
        ), this._element.classList.add (In), this._queueCallback (
          () => {
            this._element.classList.remove (In), j.trigger (
              this._element,
              'shown.bs.toast'
    ...
    hide () {
      this._element.classList.contains (Nn) &&
        (j.trigger (this._element, 'hide.bs.toast').defaultPrevented ||
          (this._element.classList.add (In), this._queueCallback (
            () => {
              this._element.classList.add (Sn), this._element.classList.remove (
                In
              ), this._element.classList.remove (Nn), j.trigger (
                this._element,
                'hidden.bs.toast'
              );
            },
    ...
    _setListeners () {
      ...
      ), j.on (this._element, 'mouseout.bs.toast', t => this._onInteraction (t, !1)), j.on (this._element, 'focusin.bs.toast', t => this._onInteraction (t, !0)), j.on (this._element, 'focusout.bs.toast', t => this._onInteraction (t, !1));
    }
    _clearTimeout () {
  ...
  return R (
    Mn
  ), g (Mn), {Alert: W, Button: z, Carousel: st, Collapse: pt, Dropdown: hi, Modal: Hi, Offcanvas: Fi, Popover: gn, ScrollSpy: An, Tab: xn, Toast: Mn, Tooltip: un};
});

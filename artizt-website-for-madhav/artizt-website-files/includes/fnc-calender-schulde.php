<div class="widget-header d-block">
	<h5 class="pull-left">FnC calendar</h5>
	<div class="pull-right">
	    <div class="notification_dropdown os_dropdown with-auto pt-0">
			<div class="dropdown">					  
				<a href="#" class="dropdown-toggle dropdown-dots ft-20 fw-700 pt-1" type="button" id="dropdownMenuButton" data-toggle="dropdown"  aria-expanded="false">...</a>

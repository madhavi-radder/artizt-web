...
<style type="text/css">
  ...
  <?php include 'includes/header-main.php';?>
      						...
      						<div class="row">
      							...
      							<div class="col-md-4 text-center profile_box">
									...
									<div class="d-md-none d-sm-block text-center" style="clear: both;">										
										<img src="images/qrcode.png" class="qrcode mar-bot-20"><br />
										<a data-toggle="modal" data-target="#addadvertisements" class="btn btn-select border-radius-30 minwidth-150 pt-2 pb-2">Promote Page</a>
									</div>
      							...
      							<div class="col-md-4 d-none d-sm-none d-md-block">
									...
									<div class="text-center pad-top-70 d-none d-sm-none d-md-block">
										<img src="images/qrcode.png" class="qrcode mar-bot-20"><br />
										<a data-toggle="modal" data-target="#addadvertisements" class="btn btn-normal-white border-radius-30 minwidth-150 pt-2 pb-2">Promote Page</a>
									</div>
	  ...
	  <section class="profile-view">
		  <div class="container">
			<div class="row">
				<div class="col-lg-4" id="mySidenav">
					...
					<div class="profile-card profile-left-card description-card min-height-auto">
						...
						<div class="accpunts_details ft-14 pt-2 pb-2">
							...
							<span class="text-truncate">@bibinmathew</span>
						</div>
						...
						<div class="accpunts_details ft-14 pt-2 pb-2 text-truncate  p-real pr-4">
							<span class="artiest_property"><img src="images/phoneverify.png" width="20px"><span class="pl-2">94443 92388 </span></span>
						</div>
						<div class="accpunts_details ft-14 pt-2 pb-2 text-truncate p-real pr-4">
							<span class="artiest_property"><img src="images/emailverify.png" width="20px"> <span class="pl-2">admin@artiztmetwork.com </span></span>
						</div>
                        <div class="divider"></div>
						<div class="accpunts_details ft-14 pt-2 pb-2 text-truncate">
					...
					<div class="vila-card">
						<div class="villa-scroll">
							<ul class="nav nav-pills mb-0" id="villa-tab" role="tablist">
							  ...
							  <li class="nav-item">
							    <a class="nav-link" id="pitch-tab" data-toggle="pill" href="#pitch" role="tab" aria-controls="pills-pitch" aria-selected="false">Pitch Reels</a>
							  </li>	
						...
						<div class="tab-content pad-20" id="villa-tabContent">
							<div class="tab-pane fade show active" id="artography" role="tabpanel" aria-labelledby="pills-home-tab">
								...
								<div class="row">
									<div class="col-md-4 col-sm-6 col-1024 mb-2">
										<p class="text-center ft-16 text-dark">My Projects</p>
										<div class="myproject">
											<div class="morevides" style="190px;">
								...
								<div class="row">
								    <div class="col-md-12 text-center mb-3">
								        <a class="ft-14 btn btn-select" href="projects-list.php">View All Projects</a>
								    </div>
								</div>
							...
							<div class="tab-pane" id="photos" role="tabpanel" aria-labelledby="pills-home-tab">
								<div class="row">
									<div class="col-md-12">
										<h3 class="pad-bot-15 pt-0 pull-left">Our Creations</h3>
								...
								<div class="row">
									<div class="col-md-12 pad-top-10">
										<h3 class="pad-bot-15 pt-0 pull-left">Posters</h3>
									</div>
								</div>
								<div class="row">
									<div class="col-md-3 col-sm-3 col-6 text-center mar-bot-20">
								...
								<div class="row">
									<div class="col-md-12 pad-top-10">
										<h3 class="pad-bot-15 pt-0 pull-left">Production</h3>
									</div>
								</div>
								<div class="row">
									<div class="col-md-3 col-sm-3 col-6 text-center mar-bot-20">
										<img src="images/production-1.jpg" class="img-fluid border-radius-15">
									</div>
									<div class="col-md-3 col-sm-3 col-6 text-center mar-bot-20">
										<img src="images/production-2.jpg" class="img-fluid border-radius-15">
									</div>
									<div class="col-md-3 col-sm-3 col-6 text-center mar-bot-20">
										<img src="images/production-3.jpg" class="img-fluid border-radius-15">
									</div>
									<div class="col-md-3 col-sm-3 col-6 text-center mar-bot-20">
										<img src="images/production-1.jpg" class="img-fluid border-radius-15">
									</div>

(window.Modernizr = (function (a, b, c) {
  ...
  for (var E in p)
    w (p, E) &&
      ((u = E.toLowerCase ()), (e[u] = p[E] ()), s.push (
        (e[u] ? '' : 'no-') + u
      ));
...
!(function (a, b, c, d) {
  ...
  function e (b, d) {
    if (
      ((this.el = b), (this.$el = a (b)), (this.s = a.extend ({}, f, d)), this.s
        .dynamic &&
    ...
    return (this.modules = {}), (this.lGalleryOn = !1), (this.lgBusy = !1), (this.hideBartimeout = !1), (this.isTouch =
      'ontouchstart' in c.documentElement), this.s.slideEndAnimatoin &&
      (this.s.hideControlOnEnd = !1), this.s.dynamic
      ...
      : 'this' === this.s.selector
          ...
          : '' !== this.s.selector
              ...
              : (this.$items = this.$el.children ()), (this.$slide =
  ...
  (e.prototype.init = function () {
    ...
    d.indexOf ('lg=' + this.s.galleryId) > 0 &&
      ((c.index = parseInt (d.split ('&slide=')[1], 10)), a ('body').addClass (
        'lg-from-hash'
      ), a ('body').hasClass ('lg-on') ||
        (setTimeout (function () {
          c.build (c.index);
        }), a ('body').addClass ('lg-on'))), c.s.dynamic
      ? (c.$el.trigger ('onBeforeOpen.lg'), (c.index = c.s.index || 0), a (
          'body'
        ).hasClass ('lg-on') ||
          setTimeout (function () {
      ...
      : c.$items.on ('click.lgcustom', function (b) {
          ...
          c.$el.trigger (
            'onBeforeOpen.lg'
          ), (c.index = c.s.index || c.$items.index (this)), a ('body').hasClass ('lg-on') || (c.build (c.index), a ('body').addClass ('lg-on'));
        });
  }), (e.prototype.build = function (b) {
    var c = this;
    c.structure (), a.each (a.fn.lightGallery.modules, function (b) {
      c.modules[b] = new a.fn.lightGallery.modules[b] (c.el);
    }), c.slide (b, !1, !1), c.s.keyPress && c.keyPress (), c.$items.length >
      1 &&
      (c.arrow (), setTimeout (function () {
        c.enableDrag (), c.enableSwipe ();
      }, 50), c.s.mousewheel &&
        c.mousewheel ()), c.counter (), c.closeGallery (), c.$el.trigger (
      'onAfterOpen.lg'
    ), c.$outer.on ('mousemove.lg click.lg touchstart.lg', function () {
      c.$outer.removeClass (
        'lg-hide-items'
      ), clearTimeout (c.hideBartimeout), (c.hideBartimeout = setTimeout (
        function () {
    ...
    for (
      a ('body').append ('<div class="lg-backdrop"></div>'), a (
        '.lg-backdrop'
      ).css ('transition-duration', this.s.backdropDuration + 'ms'), (f = 0);
      f < this.$items.length;
      f++
    )
    ...
    if (
      (this.s.controls &&
        ...
        e +
        g +
        '</div></div>'), a ('body').append (c), (this.$outer = a (
        '.lg-outer'
      )), (this.$slide = this.$outer.find ('.lg-item')), this.s.useLeft
        ? (this.$outer.addClass ('lg-use-left'), (this.s.mode = 'lg-slide'))
        : this.$outer.addClass ('lg-use-css3'), h.setTop (), a (
        b
      ).on ('resize.lg orientationchange.lg', function () {
        setTimeout (function () {
          h.setTop ();
        }, 100);
      }), this.$slide.eq (this.index).addClass ('lg-current'), this.doCss ()
        ? this.$outer.addClass ('lg-css3')
        : (this.$outer.addClass (
            'lg-css'
          ), (this.s.speed = 0)), this.$outer.addClass (this.s.mode), this.s
        .enableDrag &&
        this.$items.length > 1 &&
        this.$outer.addClass ('lg-grab'), this.s.showAfterLoad &&
        this.$outer.addClass ('lg-show-after-load'), this.doCss ())
    ) {
      var i = this.$outer.find ('.lg-inner');
      i.css ('transition-timing-function', this.s.cssEasing), i.css (
        'transition-duration',
        this.s.speed + 'ms'
      );
    }
    ...
    }, this.s.backdropDuration), this.s.download &&
      this.$outer
        .find ('.lg-toolbar')
        .append (
    ...
    if (
      ((c = this.s.dynamic
        ...
        : this.$items.eq (b).attr ('data-html')), !a && c)
    )
      return {html5: !0};
    var d = a.match (
    ...
    return d
      ? {youtube: d}
      : e ? {vimeo: e} : f ? {dailymotion: f} : g ? {vk: g} : void 0;
    ...
    if (
      (this.s.dynamic
        ...
        : ((d = this.$items.eq (b)), d.attr ('data-sub-html-url')
            ? (c = d.attr ('data-sub-html-url'))
            : ((e = d.attr ('data-sub-html')), this.s
                .getCaptionFromTitleOrAlt &&
                !e &&
                (e =
                  d.attr ('title') ||
                  d.find ('img').first ().attr ('alt')))), !c)
    )
    ...
    '.lg-sub-html' === this.s.appendSubHtmlTo
      ...
      : c
          ...
          : this.$slide.eq (b).append (e), 'undefined' != typeof e &&
      null !== e &&
      ('' === e
    ...
    if (l.s.dynamic) {
      if (
        (l.s.dynamicEl[c].poster &&
          ((m = !0), (h = l.s.dynamicEl[c].poster)), (k =
          l.s.dynamicEl[c].html), (g = l.s.dynamicEl[c].src), l.s.dynamicEl[c]
          .responsive)
      ) {
      ...
      if (
        (l.$items.eq (c).attr ('data-poster') &&
          ((m = !0), (h = l.$items
            .eq (c)
            .attr ('data-poster'))), (k = l.$items
          .eq (c)
          .attr ('data-html')), (g =
          l.$items.eq (c).attr ('href') ||
          l.$items.eq (c).attr ('data-src')), l.$items
          .eq (c)
      ...
      (i = l.$items.eq (c).attr ('data-srcset')), (j = l.$items
        .eq (c)
        .attr ('data-sizes'));
    }
    var q = !1;
    ...
    if (!l.$slide.eq (c).hasClass ('lg-loaded')) {
      if (q)
        ...
        (s = r && r.youtube
          ? 'lg-has-youtube'
          : r && r.vimeo ? 'lg-has-vimeo' : 'lg-has-html5'), l.$slide
          .eq (c)
          .prepend (
      ...
      if (
        (l.$el.trigger ('onAferAppendSlide.lg', [c]), (f = l.$slide
          .eq (c)
          .find ('.lg-object')), j && f.attr ('sizes', j), i)
      ) {
        f.attr ('srcset', i);
        try {
      ...
      '.lg-sub-html' !== this.s.appendSubHtmlTo && l.addHtml (c), l.$slide
        .eq (c)
        .addClass ('lg-loaded');
    }
    ...
    }), r && r.html5 && !m && l.$slide.eq (c).addClass ('lg-complete'), d ===
      !0 &&
      ...
      if (!f.lgBusy) {
          ...
          (k = f.s.dynamic
            ...
            : 'false' !== f.$items.eq (b).attr ('data-download-url') &&
                (f.$items.eq (b).attr ('data-download-url') ||
                  ...
                  f.$items.eq (b).attr ('data-src'))), k
            ? (a ('#lg-download').attr ('href', k), f.$outer.removeClass (
                'lg-hide-download'
              ))
        ...
        if (
          ...
          0 === b && e === g - 1
            ...
            : b === g - 1 &&
                0 === e &&
                ((m = 0), (l = g - 1)), this.$slide.removeClass (
            'lg-prev-slide lg-current lg-next-slide'
          ), f.$slide.eq (l).addClass ('lg-prev-slide'), f.$slide
            .eq (m)
            .addClass ('lg-next-slide'), f.$slide
            .eq (b)
            .addClass ('lg-current');
        } else
          f.$outer.addClass ('lg-no-trans'), this.$slide.removeClass (
            ...
            : b > e &&
                ((i = !0), b !== g - 1 ||
                  ...
                  d ||
                  ((j = !0), (i = !1))), j
            ? (this.$slide.eq (b).addClass ('lg-prev-slide'), this.$slide
                .eq (e)
                .addClass ('lg-next-slide'))
            : i &&
                (this.$slide.eq (b).addClass ('lg-next-slide'), this.$slide
                  .eq (e)
                  .addClass ('lg-prev-slide')), setTimeout (function () {
            f.$slide.removeClass (
              'lg-current'
            ), f.$slide.eq (b).addClass ('lg-current'), f.$outer.removeClass ('lg-no-trans');
          }, 50);
        f.lGalleryOn
          ? (setTimeout (function () {
              f.loadContent (b, !0, 0);
          ...
          : (f.loadContent (
              b,
              !0,
              f.s.backdropDuration
            ), (f.lgBusy = !1), f.$el.trigger ('onAfterSlide.lg', [
              e,
              b,
              c,
              d,
            ])), (f.lGalleryOn = !0), this.s.counter &&
    ...
    b.lgBusy ||
      (b.index + 1 < b.$slide.length
        ? (b.index++, b.$el.trigger ('onBeforeNextSlide.lg', [
            b.index,
          ]), b.slide (b.index, a, !1))
        : b.s.loop
            ? ((b.index = 0), b.$el.trigger ('onBeforeNextSlide.lg', [
                b.index,
              ]), b.slide (b.index, a, !1))
            : b.s.slideEndAnimatoin &&
                (b.$outer.addClass ('lg-right-end'), setTimeout (function () {
    ...
    b.lgBusy ||
      (b.index > 0
        ? (b.index--, b.$el.trigger ('onBeforePrevSlide.lg', [
            b.index,
            a,
          ]), b.slide (b.index, a, !1))
        : b.s.loop
            ? ((b.index =
                b.$items.length - 1), b.$el.trigger ('onBeforePrevSlide.lg', [
                b.index,
                a,
              ]), b.slide (b.index, a, !1))
            : b.s.slideEndAnimatoin &&
    ...
    this.$items.length > 1 &&
      a (b).on ('keyup.lg', function (a) {
        c.$items.length > 1 &&
          (37 === a.keyCode && (a.preventDefault (), c.goToPrevSlide ()), 39 ===
            a.keyCode && (a.preventDefault (), c.goToNextSlide ()));
      }), a (b).on ('keydown.lg', function (a) {
      c.s.escKey === !0 &&
        27 === a.keyCode &&
        (a.preventDefault (), c.$outer.hasClass ('lg-thumb-open')
    ...
    var d = c - b;
    Math.abs (d) > 15 &&
      (this.$outer.addClass ('lg-dragging'), this.setTranslate (
    ...
    var b = this;
    'lg-slide' !== b.s.mode && b.$outer.addClass ('lg-slide'), this.$slide
      .not ('.lg-current, .lg-prev-slide, .lg-next-slide')
      .css ('opacity', '0'), setTimeout (function () {
      b.$outer.removeClass (
        'lg-dragging'
      ), a < 0 && Math.abs (a) > b.s.swipeThreshold ? b.goToNextSlide (!0) : a > 0 && Math.abs (a) > b.s.swipeThreshold ? b.goToPrevSlide (!0) : Math.abs (a) < 5 && b.$el.trigger ('onSlideClick.lg'), b.$slide.removeAttr ('style');
    }), setTimeout (function () {
    ...
    a.s.enableSwipe &&
      ...
      (a.$slide.on ('touchstart.lg', function (c) {
        a.$outer.hasClass ('lg-zoomed') ||
          a.lgBusy ||
          (c.preventDefault (), a.manageSwipeClass (), (b =
            c.originalEvent.targetTouches[0].pageX));
      }), a.$slide.on ('touchmove.lg', function (e) {
        a.$outer.hasClass ('lg-zoomed') ||
          (e.preventDefault (), (c =
            e.originalEvent.targetTouches[0].pageX), a.touchMove (
            b,
            c
          ), (d = !0));
      ...
      (c.$slide.on ('mousedown.lg', function (b) {
        c.$outer.hasClass ('lg-zoomed') ||
          ((a (b.target).hasClass ('lg-object') ||
            ...
            (b.preventDefault (), c.lgBusy ||
              (c.manageSwipeClass (), (d =
                b.pageX), (f = !0), (c.$outer.scrollLeft += 1), (c.$outer.scrollLeft -= 1), c.$outer
                .removeClass ('lg-grab')
                .addClass ('lg-grabbing'), c.$el.trigger ('onDragstart.lg'))));
      }), a (b).on ('mousemove.lg', function (a) {
        f &&
          ((g = !0), (e = a.pageX), c.touchMove (d, e), c.$el.trigger (
            'onDragmove.lg'
          ));
    ...
    this.s.loop &&
      (0 === this.index
        ? (b = c - 1)
        : this.index === c - 1 && (a = 0)), this.$slide.removeClass (
      'lg-next-slide lg-prev-slide'
    ), b > -1 && this.$slide.eq (b).addClass ('lg-prev-slide'), this.$slide
      .eq (a)
      .addClass ('lg-next-slide');
    ...
    var d = this;
    c || d.$el.trigger ('onBeforeClose.lg'), a (b).scrollTop (
      d.prevScrollTop
    ), c &&
      (d.s.dynamic ||
        this.$items.off ('click.lg click.lgcustom'), a.removeData (
        d.el,
        'lightGallery'
      )), this.$el.off ('.lg.tm'), a.each (a.fn.lightGallery.modules, function (
      a
    ) {
      d.modules[a] && d.modules[a].destroy ();
    }), (this.lGalleryOn = !1), clearTimeout (
      d.hideBartimeout
    ), (this.hideBartimeout = !1), a (b).off ('.lg'), a ('body').removeClass (
      'lg-on lg-from-hash'
    ), d.$outer && d.$outer.removeClass ('lg-visible'), a (
      '.lg-backdrop'
    ).removeClass ('in'), setTimeout (function () {
      d.$outer &&
        d.$outer.remove (), a ('.lg-backdrop').remove (), c || d.$el.trigger ('onCloseAfter.lg');
...
!(function (a, b) {
  ...
  !(function () {
    ...
    var b = function () {
      ...
      d = function (b) {
        return (this.core = a (b).data (
          'lightGallery'
        )), (this.core.s = a.extend ({}, c, this.core.s)), this.core.s.zoom &&
          this.core.doCss () &&
          (this.init (), (this.zoomabletimeout = !1), (this.pageX =
            a (window).width () / 2), (this.pageY =
            a (window).height () / 2 + a (window).scrollTop ())), this;
      };
    (d.prototype.init = function () {
      ...
      b.core.s.actualSize &&
        (c += '<span id="lg-actual-size" class="lg-icon"></span>'), b.core.s
        .useLeftForZoom
        ? b.core.$outer.addClass ('lg-use-left-for-zoom')
        : b.core.$outer.addClass (
            'lg-use-transition-for-zoom'
          ), this.core.$outer
        .find ('.lg-toolbar')
        .append (c), b.core.$el.on ('onSlideItemLoad.lg.tm.zoom', function (
        c,
        d,
        e
      ) {
      ...
      var d = 1,
        e = function (c) {
          ...
          d
            ...
            .attr ('data-scale', c), b.core.s.useLeftForZoom
            ? d
                .parent ()
        ...
        f = function () {
          d > 1 ? b.core.$outer.addClass ('lg-zoomed') : b.resetZoom (), d <
            1 && (d = 1), e (d);
        },
        g = function (c, e, g, h) {
          ...
          b.core.$outer.hasClass ('lg-zoomed')
            ? (d = 1)
            : j > i && ((k = j / i), (d = k || 2)), h
            ? ((b.pageX = a (window).width () / 2), (b.pageY =
                a (window).height () / 2 + a (window).scrollTop ()))
            : ((b.pageX =
                c.pageX || c.originalEvent.targetTouches[0].pageX), (b.pageY =
                c.pageY ||
                c.originalEvent.targetTouches[0]
                  .pageY)), f (), setTimeout (function () {
      ...
      b.core.$el.on ('onAferAppendSlide.lg.tm.zoom', function (a, c) {
        ...
        function () {
          (b.pageX = a (window).width () / 2), (b.pageY =
            a (window).height () / 2 + a (window).scrollTop ()), e (d);
        }
      ...
      this.core.$outer.removeClass ('lg-zoomed'), this.core.$slide
        .find ('.lg-img-wrap')
        .removeAttr ('style data-x data-y'), this.core.$slide
        .find ('.lg-image')
        .removeAttr ('style data-scale'), (this.pageX =
        a (window).width () / 2), (this.pageY =
        a (window).height () / 2 + a (window).scrollTop ());
      ...
      a.core.$slide.on ('touchstart.lg', function (c) {
        if (a.core.$outer.hasClass ('lg-zoomed')) {
          ...
          (f =
            ...
            a.core.$outer.find ('.lg').height ()), (e =
            d.prop ('offsetWidth') * d.attr ('data-scale') >
            a.core.$outer.find ('.lg').width ()), (e || f) &&
            (c.preventDefault (), (b = {
        ...
        if (a.core.$outer.hasClass ('lg-zoomed')) {
          ...
          }), a.core.$outer.addClass ('lg-zoom-dragging'), (j = f
            ? -Math.abs (h.attr ('data-y')) + (c.y - b.y)
            : -Math.abs (h.attr ('data-y'))), (i = e
            ? -Math.abs (h.attr ('data-x')) + (c.x - b.x)
            : -Math.abs (h.attr ('data-x'))), (Math.abs (c.x - b.x) > 15 ||
            Math.abs (c.y - b.y) > 15) &&
      ...
      b.core.$slide.on ('mousedown.lg.zoom', function (d) {
        ...
        (h =
          ...
          b.core.$outer
            .find ('.lg')
            .height ()), (g = f.prop ('offsetWidth') * f.attr ('data-scale') > b.core.$outer.find ('.lg').width ()), b.core.$outer.hasClass ('lg-zoomed') && a (d.target).hasClass ('lg-object') && (g || h) && (d.preventDefault (), (c = {x: d.pageX, y: d.pageY}), (e = !0), (b.core.$outer.scrollLeft += 1), (b.core.$outer.scrollLeft -= 1), b.core.$outer.removeClass ('lg-grab').addClass ('lg-grabbing'));
      }), a (window).on ('mousemove.lg.zoom', function (a) {
        if (e) {
          var j, k, i = b.core.$slide.eq (b.core.index).find ('.lg-img-wrap');
          (f = !0), (d = {x: a.pageX, y: a.pageY}), b.core.$outer.addClass (
            'lg-zoom-dragging'
          ), (k = h
            ? -Math.abs (i.attr ('data-y')) + (d.y - c.y)
            : -Math.abs (i.attr ('data-y'))), (j = g
            ? -Math.abs (i.attr ('data-x')) + (d.x - c.x)
            : -Math.abs (i.attr ('data-x'))), b.core.s.useLeftForZoom
            ? i.css ({left: j + 'px', top: k + 'px'})
            : i.css ('transform', 'translate3d(' + j + 'px, ' + k + 'px, 0)');
        }
      }), a (window).on ('mouseup.lg.zoom', function (a) {
        e &&
          ((e = !1), b.core.$outer.removeClass ('lg-zoom-dragging'), !f ||
            (c.x === d.x && c.y === d.y) ||
            ((d = {x: a.pageX, y: a.pageY}), b.touchendZoom (
              c,
              d,
              g,
              h
            )), (f = !1)), b.core.$outer.removeClass ('lg-grabbing').addClass ('lg-grab');
      });
      ...
      (Math.abs (b.x - a.x) > 15 || Math.abs (b.y - a.y) > 15) &&
        (d && (i <= -k ? (i = -k) : i >= -j && (i = -j)), c &&
          ...
          : (i = -Math.abs (f.attr ('data-y'))), c
          ? f.attr ('data-x', Math.abs (h))
          : (h = -Math.abs (f.attr ('data-x'))), e.core.s.useLeftForZoom
      ...
      b.core.$el.off ('.lg.zoom'), a (window).off (
        '.lg.zoom'
      ), b.core.$slide.off ('.lg.zoom'), b.core.$el.off (
        '.lg.tm.zoom'
      ), b.resetZoom (), clearTimeout (
        b.zoomabletimeout
      ), (b.zoomabletimeout = !1);
...
!(function (e, o, i, l) {
  ...
  var a = {
    ...
    s = function (o) {
      return (this.core = e (o).data ('lightGallery')), (this.$el = e (
        o
      )), (this.core.s = e.extend (
        {},
        a,
        this.core.s
  ...
  (s.prototype.init = function () {
    ...
    o.core.$el.on ('hasVideo.lg.tm', function (e, i, l, a) {
      if (
        (o.core.$slide
          .eq (i)
          .find ('.lg-video')
          .append (o.loadVideo (l, 'lg-object', !0, i, a)), a)
      )
        if (o.core.s.videojs)
          try {
            videojs (
      ...
      o.core.$slide
        .eq (i)
        .find ('.lg-video-cont')
        .css ('max-width', o.core.s.videoMaxWidth), (o.videoLoaded = !0);
    });
    var i = function (e) {
      if (
        ...
        if (e.hasClass ('lg-has-video')) {
          ...
          var t,
            ...
            c = function (i, l) {
              if (
                (e
                  .find ('.lg-video')
                  .append (o.loadVideo (i, '', !1, o.core.index, l)), l)
              )
                if (o.core.s.videojs)
                  try {
                    videojs (
          ...
          o.core.s.dynamic
            ? ((t = o.core.s.dynamicEl[o.core.index].src), (d =
                o.core.s.dynamicEl[o.core.index].html), c (t, d))
            : ((t =
                o.core.$items.eq (o.core.index).attr ('href') ||
                o.core.$items
                  .eq (o.core.index)
                  .attr ('data-src')), (d = o.core.$items
                .eq (o.core.index)
                .attr ('data-html')), c (t, d));
          var n = e.find ('.lg-object');
          e.find ('.lg-video').append (n), e
            .find ('.lg-video-object')
            .hasClass ('lg-html5') ||
            (e.removeClass ('lg-complete'), e
              .find ('.lg-video-object')
              .on ('load.lg error.lg', function () {
    ...
    if ((l && (t = this.videoLoaded ? 0 : 1), c.youtube))
      (d = '?wmode=opaque&autoplay=' + t + '&enablejsapi=1'), this.core.s
        .youtubePlayerParams &&
        (d = d + '&' + e.param (this.core.s.youtubePlayerParams)), (r =
      ...
      (d = '?autoplay=' + t + '&api=1'), this.core.s.vimeoPlayerParams &&
        (d = d + '&' + e.param (this.core.s.vimeoPlayerParams)), (r =
      ...
      (d = '?wmode=opaque&autoplay=' + t + '&api=postMessage'), this.core.s
        .dailymotionPlayerParams &&
        (d = d + '&' + e.param (this.core.s.dailymotionPlayerParams)), (r =
...
!(function (a) {
  ...
  function f (b) {
      ...
      if (!m) {
        ...
        if (
          ...
          (e.style.width = '200px'), (e.style.padding =
            ...
            'solid'), (e.style.borderWidth = '1px 2px 3px 4px'), (e.style[k] =
            'border-box');
    ...
    function f (a) {
      if (
        (d (), 'string' == typeof a && (a = document.querySelector (a)), a &&
          'object' == typeof a &&
          a.nodeType)
      ) {
        var b = j (a);
        ...
        return z !== !1 && (f.height = z + (x ? 0 : s + w)), (f.innerWidth =
          ...
          f.height - (s + w)), (f.outerWidth = f.width + t), (f.outerHeight =
          f.height + u), f;
      }
    }
    function i (b, c) {
  ...
  function e (e) {
    return 'complete' === f.readyState
      ? d ()
      : (e.bind (f, 'DOMContentLoaded', c), e.bind (
          f,
          'readystatechange',
          c
        ), e.bind (a, 'load', c)), b;
  ...
  (d.isArray = function (a) {
    ...
    var c = d.indexOf (a, b);
    -1 != c && a.splice (c, 1);
  }), (d.isElement = 'function' == typeof HTMLElement ||
  ...
  function g (a, b) {
    a &&
      ((this.element = a), (this.layout = b), (this.position = {
        x: 0,
        y: 0,
      }), this._create ());
  }
  ...
  e.extend (g.prototype, b.prototype), (g.prototype._create = function () {
    ...
    var a = j (this.element),
      ...
      i = -1 != f.indexOf ('%')
        ...
        : parseInt (f, 10);
    (h = isNaN (h) ? 0 : h), (i = isNaN (i) ? 0 : i), (h -= c
      ? g.paddingLeft
      : g.paddingRight), (i -= d
      ? g.paddingTop
      : g.paddingBottom), (this.position.x = h), (this.position.y = i);
    ...
    (c[i] = this.getYValue (k)), (c[j] = ''), this.css (
      c
    ...
    return (a = c.isOriginLeft ? a : -a), (b = c.isOriginTop ? b : -b), n
      ? 'translate3d(' + a + 'px, ' + b + 'px, 0)'
      : 'translate(' + a + 'px, ' + b + 'px)';
  }), (g.prototype.goTo = function (a, b) {
    this.setPosition (a, b), this.layoutPosition ();
  }), (g.prototype.moveTo = m ? g.prototype._transitionTo : g.prototype.goTo), (g.prototype.setPosition = function (
    a,
    b
  ) {
  ...
  }), (g.prototype.transition = g.prototype[k ? '_transition' : '_nonTransition']), (g.prototype.onwebkitTransitionEnd = function (
    a
  ) {
  ...
  (g.prototype.ontransitionend = function (a) {
    if (a.target === this.element) {
      ...
      if (
        (delete b.ingProperties[c], f (b.ingProperties) &&
          this.disableTransition (), c in b.clean &&
          ((this.element.style[a.propertyName] = ''), delete b.clean[c]), c in
          b.onEnd)
      ) {
        var d = b.onEnd[c];
  ...
  return (g.namespace =
    ...
    this.reloadItems (), (this.stamps = []), this.stamp (
      this.options.stamp
    ), e.extend (this.element.style, this.options.containerStyle), this.options
    ...
    f
      ? ('string' == typeof f
          ...
          : e.isElement (f) && (c = f), (this[a] = c ? d (c)[b] : f))
      : (this[a] = 0);
    ...
    if (this.options.isResizingContainer) {
      ...
      a &&
        (this._setContainerMeasure (a.width, !0), this._setContainerMeasure (
          a.height,
          !1
        ));
    }
    ...
    return a
      ? ('string' == typeof a &&
          (a = this.element.querySelectorAll (a)), (a = e.makeArray (a)))
      : void 0;
  ...
  (b.prototype = new a.Item ()), (b.prototype._create = function () {
    (this.id = this.layout.itemGUID++), a.Item.prototype._create.call (
      this
    ), (this.sortData = {});
  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof exports
        ...
        : ((a.Isotope = a.Isotope || {}), (a.Isotope.LayoutMode = b (
            a.getSize,
            a.Outlayer
          )));
}) (window, function (a, b) {
  ...
  return (function () {
    ...
    return (d.prototype = new c ()), b &&
      (d.options = b), (d.prototype.namespace = a), (c.modes[a] = d), d;
  }), c;
}), (function (a, b) {
  'use strict';
  'function' == typeof define && define.amd
  ...
  c (
    d.prototype,
    b.prototype
  ), (d.prototype._getElementOffset = e), (d.prototype.layout = f), (d.prototype._getMeasurement = g);
  ...
  return (d.prototype._manageStamp = function () {
    (this.options.isOriginLeft = this.isotope.options.isOriginLeft), (this.options.isOriginTop = this.isotope.options.isOriginTop), i.apply (
      this,
      arguments
    );
  }), d;
  ...
  (m.Item = f), (m.LayoutMode = g), (m.prototype._create = function () {
    (this.itemGUID = 0), (this._sorters = {}), this._getSorters (), b.prototype._create.call (
      this
    ...
    (this.options[a] = b.options ? e.extend (b.options, c) : c), (this.modes[
      a
    ] = new b (this));
    ...
    var d = this;
    this._bindArrangeComplete (), this._isInstant
      ? this._noTransition (b)
      : b (), this._sort (), this._layout ();
    ...
    a
      ...
      : (b = this.items), this._getSorters (), this._updateItemsSortData (b);
  ...
  (m.sortDataParsers = {
    ...
    if (a) {
      ...
      this.filteredItems.sort (c), a != this.sortHistory[0] &&
    ...
    if (b.length) {
      this._resetLayout (), this._manageStamps ();
      var c = this._filterRevealAdded (b);
      this.layoutItems (this.filteredItems), (this.filteredItems = c.concat (
        this.filteredItems
      )), (this.items = b.concat (this.items));
    }
  }), (m.prototype._filterRevealAdded = function (a) {
    var b = this._filter (a);
    return this.hide (b.needHide), this.reveal (b.matches), this.layoutItems (
      b.matches,
      !0
    ), b.matches;
...
(function () {
  ...
  (i.getListeners = function (e) {
    ...
    return this;
  }), (i.removeAllListeners = n ('removeEvent')), (i.emitEvent = function (
    e,
    t
  ) {
    ...
    for (r in s)
      if (s.hasOwnProperty (r))
        for (i = s[r].length; i--; )
          (n = s[r][i]), n.once === !0 &&
            this.removeListener (e, n.listener), (o = n.listener.apply (
            this,
            t || []
  ...
  function s (e, t, n) {
    ...
    'string' == typeof e &&
      (e = document.querySelectorAll (
        e
      )), (this.elements = o (e)), (this.options = i ({}, this.options)), 'function' == typeof t ? (n = t) : i (this.options, t), n && this.on ('always', n), this.getImages (), a && (this.jqDeferred = new a.Deferred ());
    var r = this;
    setTimeout (function () {
      r.check ();
    });
  ...
  (s.prototype = new t ()), (s.prototype.options = {}), (s.prototype.getImages = function () {
    ...
    function e (e, r) {
      return t.options.debug && h && u.log ('confirm', e, r), t.progress (
        e
      ), n++, n === i && t.complete (), !0;
    }
  ...
  return (c.prototype = new t ()), (c.prototype.check = function () {
    if (!this.isChecked) {
      var e = new Image ();
      n.bind (e, 'load', this), n.bind (
        e,
        'error',
        this
      ), (e.src = this.src), (this.isChecked = !0);
    }
    ...
    (this.isConfirmed = !0), (this.isLoaded = e), this.emit (
      'confirm',
      this,
      t
    );
...
!(function (a) {
  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof exports ? (module.exports = g) : (a.classie = g);
}) (window), (function (a, b) {
  'function' == typeof define && define.amd
  ...
  return (b.Rect = a), (a.defaults = {x: 0, y: 0, width: 0, height: 0}), (a.prototype.contains = function (
    a
  ) {
  ...
  function b (a, b, c) {
    (this.width =
      a ||
      0), (this.height = b || 0), (this.sortDirection = c || 'downwardLeftToRight'), this.reset ();
  }
  (b.prototype.reset = function () {
    (this.spaces = []), (this.newSpaces = []);
    var b = new a ({x: 0, y: 0, width: this.width, height: this.height});
    this.spaces.push (b), (this.sorter =
      c[this.sortDirection] || c.downwardLeftToRight);
  ...
  return (e.prototype._create = function () {
    ...
    this.getPosition (), this.removeTransitionStyles (), this.isTransitioning &&
      d &&
      (this.element.style[d] =
        'none'), this.getSize (), (this.isPlacing = !0), (this.needsPositioning = !1), this.positionPlaceRect (
      this.position.x,
      this.position.y
    ...
    (this.placeRect.x = this.getPlaceRectCoord (
      a,
      !0
    ...
    b ||
      ((g = Math.max (g, this.layout.maxY)), this.layout.rowHeight ||
        (g -= this.layout.gutter));
    var h;
    if (f) {
      (f += this.layout.gutter), (g += b
        ? this.layout.gutter
        : 0), (a = Math.round (a / f));
      var i;
    ...
    this.element.parentNode.removeChild (
      this.element
    ), this.layout.packer.addSpace (this.rect), this.emitEvent ('remove', [
      this,
    ]);
  }), e;
}), (function (a, b) {
  ...
  return (i.Item = f), (i.prototype._create = function () {
    c.prototype._create.call (this), (this.packer = new e ()), this.stamp (
      this.options.stamped
    );
    var a = this;
    ...
    this.options.isHorizontal
      ? ((a.width = Number.POSITIVE_INFINITY), (a.height =
          this.size.innerHeight + this.gutter), (a.sortDirection =
          'rightwardTopToBottom'))
      : ((a.width = this.size.innerWidth + this.gutter), (a.height =
          Number.POSITIVE_INFINITY), (a.sortDirection =
          'downwardLeftToRight')), a.reset (), (this.maxY = 0), (this.maxX = 0);
  }), (i.prototype._getMeasurements = function () {
    this._getMeasurement ('columnWidth', 'width'), this._getMeasurement (
      'rowHeight',
      'height'
    ...
    this._setRectSize (a.element, a.rect), this.packer.pack (
      a.rect
    ), this._setMaxXY (a.rect);
  }), (i.prototype._setMaxXY = function (a) {
    (this.maxX = Math.max (a.x + a.width, this.maxX)), (this.maxY = Math.max (
      a.y + a.height,
      this.maxY
    ));
    ...
    (e || f) &&
      ((e = this._applyGridGutter (
        e,
        this.columnWidth
      )), (f = this._applyGridGutter (
        f,
        this.rowHeight
      ))), (c.width = Math.min (e, this.packer.width)), (c.height = Math.min (
      f,
      this.packer.height
    ));
    ...
    d &&
      (this._getMeasurements (), this.stamp (
        d.element
      ), d.getSize (), (d.isPlacing = !0), (b = void 0 === b
        ? d.rect.x
        : b), (c = void 0 === c ? d.rect.y : c), d.positionPlaceRect (
        b,
        c,
        !0
      ), this._bindFitEvents (d), d.moveTo (
        d.placeRect.x,
        d.placeRect.y
      ), this.layout (), this.unstamp (
        d.element
    ...
    d.needsPositioning
      ...
      : d && d.copyPlaceRectPosition (), this.clearDragTimeout (), this.on (
      'layoutComplete',
      e
    ), this.layout ();
    ...
    return function () {
      return e++, e != f
        ...
        : (c &&
            ...
            ), (c.isPlacing = !1), c.copyPlaceRectPosition ()), g.unstamp (
            b
          ), g.sortItemsByPosition (), d &&
            g.emitEvent ('dragItemPositioned', [c]), !0);
    };
  }), (i.prototype.bindDraggabillyEvents = function (a) {
    a.on ('dragStart', this.handleDraggabilly.dragStart), a.on (
      'dragMove',
      this.handleDraggabilly.dragMove
  ...
  d (
    e.prototype,
    b.prototype
  ), (e.prototype._getElementOffset = f), (e.prototype._getMeasurement = g);
  ...
  return (e.prototype._manageStamp = function () {
    (this.options.isOriginLeft = this.isotope.options.isOriginLeft), (this.options.isOriginTop = this.isotope.options.isOriginTop), j.apply (
      this,
      arguments
    );
    ...
    var r = {
      init: function (i) {
        ...
        var r = (this.share.settings, this.share.settings.networks),
          ...
          p = '';
        return t.each (t (s).find ('meta[name="description"]'), function (
          e,
          s
        ) {
          p = t (s).attr ('content');
          ...
          r.forEach (function (e) {
            (s =
              n.networkDefs[e]
                .url), (s = s.replace ('|u|', d).replace ('|t|', f).replace ('|d|', g).replace ('|140|', f.substring (0, 130))), t ("<a href='" + s + "' title='Share this page on " + e + "' class='pop share-" + o + ' share-' + o + '-' + e + "'></a>").appendTo (i);
          }), t ('#' + m + '.share-' + o).css (
            'margin',
            h
          ), 'horizontal' != a ? t ('#' + m + ' a.share-' + o).css ('display', 'block') : t ('#' + m + ' a.share-' + o).css ('display', 'inline-block'), 'undefined' != typeof u && (i.addClass ('share-affix'), -1 != u.indexOf ('right') ? (i.css ('left', 'auto'), i.css ('right', '0px'), -1 != u.indexOf ('center') && i.css ('top', '40%')) : -1 != u.indexOf ('left center') && i.css ('top', '40%'), -1 != u.indexOf ('bottom') && (i.css ('bottom', '0px'), i.css ('top', 'auto'), -1 != u.indexOf ('center') && i.css ('left', '40%'))), t (
            '.pop'
          ).click (function () {
            return e.open (
              t (this).attr ('href'),
...
'function' != typeof Object.create &&
  ...
  var a = function (e) {
    ...
    (t.src =
      location.protocol + '//www.youtube.com/iframe_api'), a.appendChild (
      t
    ), (a = null), (t = null), n (e);
  },
    n = function (o) {
      'undefined' == typeof YT && 'undefined' == typeof t.loadingPlayer
        ? ((t.loadingPlayer = !0), (t.dfd = e.Deferred ()), (t.onYouTubeIframeAPIReady = function () {
  ...
  (YTPlayer = {
    ...
    init: function (o, n) {
      var i = this;
      return (i.userOptions = n), (i.$body = e ('body')), (i.$node = e (
        o
      )), (i.$window = e (t)), (i.defaults.events = {
        onReady: function (e) {
          i.onPlayerReady (e), i.options.pauseOnScroll &&
            i.pauseOnScroll (), 'function' == typeof i.options.callback &&
        ...
        i.defaults,
        i.userOptions
      )), (i.ID = new Date ().getTime ()), (i.holderID =
        'YTPlayer-ID-' + i.ID), i.options.fitToBackground
        ? i.createBackgroundVideo ()
        : i.createContainerVideo (), i.$window.on (
        'resize.YTplayer' + i.ID,
        function () {
          i.resize (i);
        }
    ...
    resize: function (t) {
      ...
      i / t.options.ratio < r
        ? ((a = Math.ceil (r * t.options.ratio)), l
            .width (a)
            .height (r)
            .css ({left: (i - a) / 2, top: 0}))
        : ((n = Math.ceil (i / t.options.ratio)), l
            .width (i)
            .height (n)
            .css ({left: 0, top: 0})), (l = null), (o = null);
    },
    ...
    destroy: function () {
      ...
      o.$node
        .removeData ('yt-init')
        .removeData ('ytPlayer')
        .removeClass ('loaded'), o.$YTPlayerString.remove (), e (t).off (
        'resize.YTplayer' + o.ID
      ), e (t).off (
        'scroll.YTplayer' + o.ID
      ), (o.$body = null), (o.$node = null), (o.$YTPlayerString = null), o.player.destroy (), (o.player = null);
    },
        ...
        if (ha) {
          ...
          for (var c = 0; c < ha; c++)
            (I = x[c]), (y = L (I.element, a)), 0 > y[r ? 'right' : 'bottom'] ||
              ...
              ((ja = I.options), (R = ja.offset || t.offset || 0), (J =
                y[r ? 'right' : 'bottom']), (z =
                y[r ? 'width' : 'height']), (A = (z - J + R) / z), 0 > A &&
                ((J = y[r ? 'left' : 'top']), (z =
                  H[r ? 'width' : 'height']), (A = -1 + (z - J + R) / z)), 1 <
                A ||
                -1 > A ||
                b (I, A, r));
          u ('scroll', H);
      ...
      function b (a, b) {
        ...
        if (c)
          for (var f = 0; f < c; f++) {
            ...
            U =
              T.properties || (r ? {translateX: '100%'} : {translateY: '100%'});
            D = '';
            for (B in U) {
              n = U[B];
...
(function (factory) {
  ...
  $.fn.tweet = function (o) {
    ...
    function extract_template_data (item) {
      ...
      o.join_text = s.join_text == 'auto'
        ? build_auto_join_text (item.text)
        : s.join_text;
  ...
  e.fn.niceSelect = function (t) {
    ...
    function s (t) {
      ...
      if (t.attr ('multiple')) {
        ...
        (a = t.find ('option:selected')).each (function () {
          ($selected_option = e (
            this
          )), ($selected_text = $selected_option.data ('display') || $selected_option.text ()), (c += '<span class="current">' + $selected_text + '</span>');
        }), ($select_placeholder =
          t.data ('placeholder') ||
          t.attr ('placeholder')), ($select_placeholder = '' ==
          $select_placeholder
          ? 'Select'
          : $select_placeholder), (c = '' == c
          ? $select_placeholder
          : c), s.find ('.multiple-options').html (c);
      } else {
    ...
    this.hide (), this.each (function () {
      ...
      e ('.nice-select')
        ...
        .removeClass (
          'open'
        ), s.toggleClass ('open'), s.hasClass ('open') ? (s.find ('.option'), s.find ('.nice-select-search').val (''), s.find ('.nice-select-search').focus (), s.find ('.focus').removeClass ('focus'), s.find ('.selected').addClass ('focus'), s.find ('ul li').show ()) : s.focus ();
      ...
      if (l.hasClass ('has-multiple'))
        s.hasClass ('selected')
          ...
          : s.addClass ('selected'), ($selected_html =
          ''), ($selected_values = []), l.find ('.selected').each (function () {
          $selected_option = e (this);
          var t = $selected_option.data ('display') || $selected_option.text ();
          ($selected_html +=
            '<span class="current">' +
            t +
            '</span>'), $selected_values.push ($selected_option.data ('value'));
        }), ($select_placeholder =
          l.prev ('select').data ('placeholder') ||
          l.prev ('select').attr ('placeholder')), ($select_placeholder = '' ==
          $select_placeholder
          ? 'Select'
          : $select_placeholder), ($selected_html = '' == $selected_html
          ? $select_placeholder
          : $selected_html), l
          .find ('.multiple-options')
          .html ($selected_html), l
          .prev ('select')
          .val ($selected_values)
          .trigger ('change');
      else {
      ...
      document
    ).on ('keydown.nice-select-search', '.nice-select', function () {
      var t = e (this),
    ...
    return (l.cssText = 'pointer-events:auto'), 'auto' !== l.pointerEvents &&
      e ('html').addClass ('no-csspointerevents'), this;
  };
}) (jQuery);
// calendar
!(function (e, t) {
      ...
      if (
        (e._strict &&
          (s =
            ...
            void 0 === t.bigHour), null != Object.isFrozen &&
          Object.isFrozen (e))
      )
        return s;
      e._isValid = s;
  ...
  function w (e, t) {
    var n, s, i;
    if (
      (l (t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), l (
        t._i
      ) || (e._i = t._i), l (t._f) || (e._f = t._f), l (t._l) ||
        (e._l = t._l), l (t._strict) || (e._strict = t._strict), l (t._tzm) ||
        (e._tzm = t._tzm), l (t._isUTC) || (e._isUTC = t._isUTC), l (
        t._offset
      ) || (e._offset = t._offset), l (t._pf) || (e._pf = g (t)), l (
        t._locale
  ...
  I ('Y', 0, 0, function () {
    ...
    0,
    'year'
  ), I (0, ['YYYYY', 5], 0, 'year'), I (0, ['YYYYYY', 6, !0], 0, 'year'), H ('year', 'y'), L ('year', 1), ue ('Y', se), ue ('YY', B, z), ue ('YYYY', ee, q), ue ('YYYYY', te, J), ue ('YYYYYY', te, J), ce (['YYYYY', 'YYYYYY'], me), ce ('YYYY', function (e, t) {
  ...
  (Ye = Array.prototype.indexOf
    ...
    'month',
    'M'
  ), L ('month', 8), ue ('M', B), ue ('MM', B, z), ue ('MMM', function (e, t) {
  ...
  I (
    ...
    'wo',
    'week'
  ), I ('W', ['WW', 2], 'Wo', 'isoWeek'), H ('week', 'w'), H ('isoWeek', 'W'), L ('week', 5), L ('isoWeek', 5), ue ('w', B), ue ('ww', B, z), ue ('W', B), ue ('WW', B, z), fe (['w', 'ww', 'W', 'WW'], function (e, t, n, s) {
    t[s.substr (0, 1)] = k (e);
  });
  I ('d', 0, 'do', 'day'), I ('dd', 0, 0, function (e) {
    ...
    0,
    'weekday'
  ), I ('E', 0, 0, 'isoWeekday'), H ('day', 'd'), H ('weekday', 'e'), H ('isoWeekday', 'E'), L ('day', 11), L ('weekday', 11), L ('isoWeekday', 11), ue ('d', B), ue ('e', B), ue ('E', B), ue ('dd', function (e, t) {
  ...
  I (
    ...
    0,
    'hour'
  ), I ('h', ['hh', 2], 0, Qe), I ('k', ['kk', 2], 0, function () {
    return this.hours () || 24;
  }), I ('hmm', 0, 0, function () {
    return '' + Qe.apply (this) + U (this.minutes (), 2);
  }), I ('hmmss', 0, 0, function () {
    return (
      '' + Qe.apply (this) + U (this.minutes (), 2) + U (this.seconds (), 2)
    );
  }), I ('Hmm', 0, 0, function () {
    ...
    'a',
    !0
  ), Xe ('A', !1), H ('hour', 'h'), L ('hour', 13), ue ('a', Ke), ue ('A', Ke), ue ('H', B), ue ('h', B), ue ('k', B), ue ('HH', B, z), ue ('hh', B, z), ue ('kk', B, z), ue ('hmm', Q), ue ('hmmss', X), ue ('Hmm', Q), ue ('Hmmss', X), ce (['H', 'HH'], ge), ce (['k', 'kk'], function (e, t, n) {
    var s = k (e);
    t[ge] = 24 === s ? 0 : s;
    ...
    (t[ge] = k (
      e.substr (0, s)
    )), (t[pe] = k (e.substr (s))), (g (n).bigHour = !0);
  }), ce ('hmmss', function (e, t, n) {
    var s = e.length - 4, i = e.length - 2;
    (t[ge] = k (
      e.substr (0, s)
    )), (t[pe] = k (e.substr (s, 2))), (t[ve] = k (e.substr (i))), (g (n).bigHour = !0);
  }), ce ('Hmm', function (e, t, n) {
    var s = e.length - 2;
    ...
    (t[ge] = k (
      e.substr (0, s)
    )), (t[pe] = k (e.substr (s, 2))), (t[ve] = k (e.substr (i)));
  });
  var et,
    tt = Te ('Hours', !0),
    nt = {
      ...
      if (((t.abbr = e), null != st[e]))
        ...
        if (null != st[t.parentLocale]) s = st[t.parentLocale]._config;
          ...
          if (null == (n = at (t.parentLocale)))
            return it[t.parentLocale] || (it[t.parentLocale] = []), it[
              t.parentLocale
            ].push ({name: e, config: t}), null;
          s = n._config;
        }
      return (st[e] = new P (b (s, t))), it[e] &&
  ...
  function lt (e) {
    ...
    return (function (e) {
      for (var t, n, s, i, r = 0; r < e.length; ) {
        for (
          (t = (i = rt (e[r]).split ('-')).length), (n = (n = rt (e[r + 1]))
            ? n.split ('-')
            : null);
          0 < t;
        ...
        : n[ye] < 1 || n[ye] > Pe (n[me], n[_e])
            ...
            : n[ge] < 0 ||
                ...
                : n[pe] < 0 || 59 < n[pe]
                    ...
                    : n[ve] < 0 || 59 < n[ve]
                        ? ve
                        : n[we] < 0 || 999 < n[we] ? we : -1), g (e)
        ._overflowDayOfYear &&
        (t < me || ye < t) &&
        (t = ye), g (e)._overflowWeeks && -1 === t && (t = Me), g (e)
        ._overflowWeekday &&
        -1 === t &&
        (t = Se), (g (e).overflow = t)), e;
  }
  function ht (e, t, n) {
          ...
          (function (e) {
            ...
            if (null != (t = e._w).GG || null != t.W || null != t.E)
              (r = 1), (a = 4), (n = ht (
                ...
                e._a[me],
                Ie (Tt (), 1, 4).year
              )), (s = ht (t.W, 1)), ((i = ht (t.E, 1)) < 1 || 7 < i) &&
                (u = !0);
            else {
              (r = e._locale._week.dow), (a = e._locale._week.doy);
              var l = Ie (Tt (), r, a);
              (n = ht (t.gg, e._a[me], l.year)), (s = ht (t.w, l.week)), null !=
                t.d
                ? ((i = t.d) < 0 || 6 < i) && (u = !0)
                : null != t.e
            ...
            s < 1 || s > Ae (n, r, a)
              ...
              : null != u
                  ...
                  : ((o = Ee (n, s, i, r, a)), (e._a[me] =
                      o.year), (e._dayOfYear = o.dayOfYear));
          }) (e), null != e._dayOfYear &&
          ((r = ht (e._a[me], s[me])), (e._dayOfYear > De (r) ||
            0 === e._dayOfYear) &&
            (g (e)._overflowDayOfYear = !0), (n = Ge (
            r,
            0,
            e._dayOfYear
          )), (e._a[_e] = n.getUTCMonth ()), (e._a[
            ye
          ] = n.getUTCDate ())), (t = 0);
        t < 3 && null == e._a[t];
        ++t
  ...
  function Dt (e) {
    ...
    if (i) {
      ...
      (e._a = r), (e._tzm = (function (e, t, n) {
        ...
        return (s - i) / 100 * 60 + i;
      }) (i[8], i[9], i[10])), (e._d = Ge.apply (
        null,
        e._a
      )), e._d.setUTCMinutes (e._d.getUTCMinutes () - e._tzm), (g (
        e
      ).rfc2822 = !0);
    } else e._isValid = !1;
  }
        ...
        for (
          ...
          (i = s[t]), (n = (l.match (le (i, e)) || [])[0]) &&
            (0 < (r = l.substr (0, l.indexOf (n))).length &&
              g (e).unusedInput.push (r), (l = l.slice (
              l.indexOf (n) + n.length
            )), (h += n.length)), E[i]
            ? (n
                ? (g (e).empty = !1)
                : g (e).unusedTokens.push (i), (a = i), (u = e), null !=
                (o = n) &&
                m (he, a) &&
                he[a] (o, u._a, u, a))
            : e._strict && !n && g (e).unusedTokens.push (i);
        (g (e).charsLeftOver = d - h), 0 < l.length &&
          g (e).unusedInput.push (l), e._a[ge] <= 12 &&
          !0 === g (e).bigHour &&
          0 < e._a[ge] &&
          (g (e).bigHour = void 0), (g (e).parsedDateParts = e._a.slice (
          0
        )), (g (e).meridiem = e._meridiem), (e._a[ge] = (function (e, t, n) {
          var s;
          if (null == n) return t;
          return null != e.meridiemHour
            ? e.meridiemHour (t, n)
            : (null != e.isPM &&
                ((s = e.isPM (n)) && t < 12 && (t += 12), s ||
                  12 !== t ||
                  (t = 0)), t);
  ...
  function Yt (e) {
    ...
    return (e._locale = e._locale || lt (e._l)), null === r ||
      (void 0 === a && '' === r)
      ? v ({nullInput: !0})
      : ('string' == typeof r && (e._i = r = e._locale.preparse (r)), S (r)
          ? new M (dt (r))
          : (h (r)
              ? (e._d = r)
              : o (a)
                  ? (function (e) {
                      ...
                      for (i = 0; i < e._f.length; i++)
                        (r = 0), (t = w ({}, e)), null != e._useUTC &&
                          (t._useUTC = e._useUTC), (t._f = e._f[i]), kt (t), p (
                          t
                        ) &&
                          ((r += g (t).charsLeftOver), (r +=
                            10 * g (t).unusedTokens.length), (g (
                            t
                          ).score = r), (null == s || r < s) &&
                            ((s = r), (n = t)));
                      _ (e, n || t);
                  ...
                  : a
                      ...
                      : l ((n = (t = e)._i))
                          ...
                          : h (n)
                              ...
                              : 'string' == typeof n
                                  ? ((s = t), null === (i = pt.exec (s._i))
                                      ? (vt (s), !1 === s._isValid &&
                                          (delete s._isValid, Dt (s), !1 ===
                                            s._isValid &&
                                            (delete s._isValid, c.createFromInputFallback (
                                              s
                                            ))))
                                      : (s._d = new Date (+i[1])))
                                  : o (n)
  ...
  function Ot (e, t, n, s, i) {
    ...
    return (!0 !== n && !1 !== n) || ((s = n), (n = void 0)), ((u (e) &&
      ...
      (o (e) && 0 === e.length)) &&
      (e = void 0), (a._isAMomentObject = !0), (a._useUTC = a._isUTC = i), (a._l = n), (a._i = e), (a._f = t), (a._strict = s), (r = new M (dt (Yt (a))))._nextDay && (r.add (1, 'd'), (r._nextDay = void 0)), r;
  }
  function Tt (e, t, n, s) {
    return Ot (e, t, n, s, !1);
  }
  ...
  function Ht (e) {
    ...
    (this._isValid = (function (e) {
      ...
      t
    )), (this._milliseconds = +d + 1e3 * l + 6e4 * u + 1e3 * o * 60 * 60), (this._days = +a + 7 * r), (this._months = +i + 3 * s + 12 * n), (this._data = {}), (this._locale = lt ()), this._bubble ();
  }
  function Rt (e) {
  ...
  function Nt (e, t) {
    ...
    return t._isUTC
      ? ((n = t.clone ()), (s =
          ...
          n.valueOf ()), n._d.setTime (n._d.valueOf () + s), c.updateOffset (
          n,
          !1
        ), n)
      : Tt (e).local ();
                  ...
                  : null == r
                      ...
                      : 'object' == typeof r &&
                          ...
                          ((i = (function (e, t) {
                            ...
                            return n;
                          }) (Tt (r.from), Tt (r.to))), ((r = {}).ms =
                            i.milliseconds), (r.M =
                            i.months)), (s = new Ht (r)), Rt (e) && m (e, '_locale') && (s._locale = e._locale), s;
  }
  function jt (e, t) {
  ...
  function $t (e, t, n, s) {
    ...
    e.isValid () &&
      ((s = null == s || s), a && Ce (e, xe (e, 'Month') + a * n), r &&
        be (e, 'Date', xe (e, 'Date') + r * n), i &&
        e._d.setTime (e._d.valueOf () + i * n), s &&
    ...
    return (
      -(n +
        (t - s < 0
          ...
          : (t - s) / (e.clone ().add (n + 1, 'months') - s))) || 0
    );
  }
  function Qt (e) {
    var t;
  ...
  function tn (e, t, n, s, i) {
    ...
    return null == e
      ? Ie (this, s, i).year
      : ((r = Ae (e, s, i)) < t && (t = r), function (e, t, n, s, i) {
  ...
  I (0, ['gg', 2], 0, function () {
    ...
    'gggg',
    'weekYear'
  ), en ('ggggg', 'weekYear'), en ('GGGG', 'isoWeekYear'), en ('GGGGG', 'isoWeekYear'), H ('weekYear', 'gg'), H ('isoWeekYear', 'GG'), L ('weekYear', 1), L ('isoWeekYear', 1), ue ('G', se), ue ('g', se), ue ('GG', B, z), ue ('gg', B, z), ue ('GGGG', ee, q), ue ('gggg', ee, q), ue ('GGGGG', te, J), ue ('ggggg', te, J), fe (['gggg', 'ggggg', 'GGGG', 'GGGGG'], function (e, t, n, s) {
    t[s.substr (0, 2)] = k (e);
    ...
    'Qo',
    'quarter'
  ), H ('quarter', 'Q'), L ('quarter', 7), ue ('Q', Z), ce ('Q', function (e, t) {
    t[_e] = 3 * (k (e) - 1);
  }), I (
    'D',
    ['DD', 2],
    'Do',
    'date'
  ), H ('date', 'D'), L ('date', 9), ue ('D', B), ue ('DD', B, z), ue ('Do', function (e, t) {
    return e
  ...
  I (
    ...
    'DDDo',
    'dayOfYear'
  ), H ('dayOfYear', 'DDD'), L ('dayOfYear', 4), ue ('DDD', K), ue ('DDDD', $), ce (['DDD', 'DDDD'], function (e, t, n) {
    n._dayOfYear = k (e);
  }), I (
    'm',
    ['mm', 2],
    0,
    'minute'
  ), H ('minute', 'm'), L ('minute', 14), ue ('m', B), ue ('mm', B, z), ce (['m', 'mm'], pe);
  var sn = Te ('Minutes', !1);
  I (
    's',
    ['ss', 2],
    0,
    'second'
  ), H ('second', 's'), L ('second', 15), ue ('s', B), ue ('ss', B, z), ce (['s', 'ss'], ve);
  ...
  (ln.add = qt), (ln.calendar = function (e, t) {
    ...
    return (
      ...
      ('millisecond' === (t = R (t || 'millisecond'))
        ...
        : ((n = s.valueOf ()), this.clone ().startOf (t).valueOf () <= n &&
    ...
    var e = 'moment', t = '';
    this.isLocal () ||
      ((e = 0 === this.utcOffset () ? 'moment.utc' : 'moment.parseZone'), (t =
        'Z'));
    var n = '[' + e + '("]',
    ...
    return null != e
      ? ((t = e), (n = this.localeData ()), (e = 'string' != typeof t
          ? t
          : isNaN (t)
              ? 'number' == typeof (t = n.weekdaysParse (t)) ? t : null
              : parseInt (t, 10)), this.add (e - s, 'd'))
      : s;
    ...
    return null == e ? t : this.add (e - t, 'd');
  }), (ln.hour = ln.hours = tt), (ln.minute = ln.minutes = sn), (ln.second = ln.seconds = an), (ln.millisecond = ln.milliseconds = un), (ln.utcOffset = function (
    e,
    t,
    n
  ) {
    ...
    if (null != e) {
      ...
      return !this._isUTC &&
        t &&
        (s = Gt (this)), (this._offset = e), (this._isUTC = !0), null != s &&
        this.add (s, 'm'), i !== e &&
        (!t || this._changeInProgress
          ? $t (this, At (e - i, 'm'), 1, !1)
          : this._changeInProgress ||
              ((this._changeInProgress = !0), c.updateOffset (
                this,
                !0
  ...
  }), (ln.dates = n ('dates accessor is deprecated. Use date instead.', nn)), (ln.months = n ('months accessor is deprecated. Use month instead', Fe)), (ln.years = n ('years accessor is deprecated. Use year instead', Oe)), (ln.zone = n (
  ...
  (hn.calendar = function (e, t, n) {
      ...
      if (
        ((i = y ([2e3, s])), n &&
          ...
          ((r =
            ...
            this.months (i, '') +
            '|^' +
            this.monthsShort (i, '')), (this._monthsParse[s] = new RegExp (
            r.replace ('.', ''),
            'i'
    ...
    return this._monthsParseExact
      ? (m (this, '_monthsRegex') || Ne.call (this), e
          ? this._monthsStrictRegex
          : this._monthsRegex)
      : (m (this, '_monthsRegex') || (this._monthsRegex = Ue), this
          ._monthsStrictRegex && e
          ? this._monthsStrictRegex
          : this._monthsRegex);
    ...
    return this._monthsParseExact
      ...
      : (m (this, '_monthsShortRegex') || (this._monthsShortRegex = Le), this
          ._monthsShortStrictRegex && e
          ? this._monthsShortStrictRegex
          : this._monthsShortRegex);
  }), (hn.week = function (e) {
    ...
    for (
      this._weekdaysParse ||
        ((this._weekdaysParse = []), (this._minWeekdaysParse = []), (this._shortWeekdaysParse = []), (this._fullWeekdaysParse = [])), (s = 0);
      s < 7;
      s++
    ) {
      if (
        ((i = y ([2e3, 1]).day (s)), n &&
          ...
          ((r =
            ...
            '|^' +
            this.weekdaysMin (i, '')), (this._weekdaysParse[s] = new RegExp (
            r.replace ('.', ''),
            'i'
    ...
    return this._weekdaysParseExact
      ? (m (this, '_weekdaysRegex') || Be.call (this), e
          ? this._weekdaysStrictRegex
          : this._weekdaysRegex)
      : (m (this, '_weekdaysRegex') || (this._weekdaysRegex = $e), this
          ._weekdaysStrictRegex && e
          ? this._weekdaysStrictRegex
          : this._weekdaysRegex);
    ...
    return this._weekdaysParseExact
      ...
      : (m (this, '_weekdaysShortRegex') ||
          (this._weekdaysShortRegex = qe), this._weekdaysShortStrictRegex && e
          ? this._weekdaysShortStrictRegex
          : this._weekdaysShortRegex);
    ...
    return this._weekdaysParseExact
      ...
      : (m (this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = Je), this
          ._weekdaysMinStrictRegex && e
          ? this._weekdaysMinStrictRegex
          : this._weekdaysMinRegex);
  }), (hn.isPM = function (e) {
  ...
  return (In.isValid = function () {
    ...
    var e = this._data;
    return (this._milliseconds = _n (this._milliseconds)), (this._days = _n (
      this._days
    )), (this._months = _n (this._months)), (e.milliseconds = _n (
      e.milliseconds
    )), (e.seconds = _n (e.seconds)), (e.minutes = _n (
      e.minutes
    )), (e.hours = _n (e.hours)), (e.months = _n (e.months)), (e.years = _n (
      e.years
    )), this;
  }), (In.add = function (e, t) {
    ...
    if ('month' === (e = R (e)) || 'year' === e)
      return (t = this._days + s / 864e5), (n =
        this._months + pn (t)), 'month' === e ? n : n / 12;
    ...
    return (0 <= r && 0 <= a && 0 <= o) ||
      (r <= 0 && a <= 0 && o <= 0) ||
      ((r += 864e5 * gn (vn (o) + a)), (o = a = 0)), (u.milliseconds =
      r % 1e3), (e = D (r / 1e3)), (u.seconds = e % 60), (t = D (
      e / 60
    )), (u.minutes = t % 60), (n = D (t / 60)), (u.hours =
      n % 24), (o += i = D (pn ((a += D (n / 24))))), (a -= gn (
      vn (i)
    )), (s = D (
      o / 12
    ...
    var t,
      ...
      h,
      c = this.localeData (),
      f = ((n = !e), (s = c), (i = At ((t = this)).abs ()), (r = Un (
        i.as ('s')
      )), (a = Un (i.as ('m'))), (o = Un (i.as ('h'))), (u = Un (
        i.as ('d')
...
!(function (t, a) {
  ...
  var i = function (t, e, a) {
    if (
      ((this.parentEl = 'body'), (this.element = R (
        t
      )), (this.startDate = H ().startOf ('day')), (this.endDate = H ().endOf (
        'day'
      )), (this.minDate = !1), (this.maxDate = !1), (this.maxSpan = !1), (this.autoApply = !1), (this.singleDatePicker = !1), (this.showDropdowns = !1), (this.minYear = H ()
        .subtract (100, 'year')
        .format ('YYYY')), (this.maxYear = H ()
        .add (100, 'year')
        .format (
          'YYYY'
        )), (this.showWeekNumbers = !1), (this.showISOWeekNumbers = !1), (this.showCustomRangeLabel = !0), (this.timePicker = !1), (this.timePicker24Hour = !1), (this.timePickerIncrement = 1), (this.timePickerSeconds = !1), (this.linkedCalendars = !0), (this.autoUpdateInput = !0), (this.alwaysShowCalendars = !1), (this.ranges = {}), (this.opens =
        'right'), this.element.hasClass ('pull-right') &&
        (this.opens = 'left'), (this.drops = 'down'), this.element.hasClass (
        'dropup'
      ) && (this.drops = 'up'), (this.buttonClasses =
        'btn btn-sm'), (this.applyButtonClasses =
        'btn-primary'), (this.cancelButtonClasses =
        'btn-default'), (this.locale = {
        direction: 'ltr',
      ...
      }), (this.callback = function () {}), (this.isShowing = !1), (this.leftCalendar = {}), (this.rightCalendar = {}), ('object' ==
        typeof e &&
        null !== e) ||
        (e = {}), 'string' ==
        ...
        R (e.parentEl).length
        ? R (e.parentEl)
        : R (this.parentEl)), (this.container = R (e.template).appendTo (
        this.parentEl
      )), 'object' == typeof e.locale &&
        ('string' == typeof e.locale.direction &&
          (this.locale.direction = e.locale.direction), 'string' ==
          typeof e.locale.format &&
          (this.locale.format = e.locale.format), 'string' ==
          typeof e.locale.separator &&
          (this.locale.separator = e.locale.separator), 'object' ==
          typeof e.locale.daysOfWeek &&
          (this.locale.daysOfWeek = e.locale.daysOfWeek.slice ()), 'object' ==
          typeof e.locale.monthNames &&
          (this.locale.monthNames = e.locale.monthNames.slice ()), 'number' ==
          typeof e.locale.firstDay &&
          (this.locale.firstDay = e.locale.firstDay), 'string' ==
          typeof e.locale.applyLabel &&
          (this.locale.applyLabel = e.locale.applyLabel), 'string' ==
          typeof e.locale.cancelLabel &&
          (this.locale.cancelLabel = e.locale.cancelLabel), 'string' ==
          typeof e.locale.weekLabel &&
          (this.locale.weekLabel = e.locale.weekLabel), 'string' ==
          typeof e.locale.customRangeLabel))
    ) {
    ...
    if(
      (this.container.addClass (this.locale.direction), 'string' ==
        typeof e.startDate &&
        (this.startDate = H (e.startDate, this.locale.format)), 'string' ==
        typeof e.endDate &&
        (this.endDate = H (e.endDate, this.locale.format)), 'string' ==
        typeof e.minDate &&
        (this.minDate = H (e.minDate, this.locale.format)), 'string' ==
        typeof e.maxDate &&
        (this.maxDate = H (e.maxDate, this.locale.format)), 'object' ==
        typeof e.startDate && (this.startDate = H (e.startDate)), 'object' ==
        typeof e.endDate && (this.endDate = H (e.endDate)), 'object' ==
        typeof e.minDate && (this.minDate = H (e.minDate)), 'object' ==
        typeof e.maxDate && (this.maxDate = H (e.maxDate)), this.minDate &&
        this.startDate.isBefore (this.minDate) &&
        (this.startDate = this.minDate.clone ()), this.maxDate &&
        this.endDate.isAfter (this.maxDate) &&
        (this.endDate = this.maxDate.clone ()), 'string' ==
        typeof e.applyButtonClasses &&
        (this.applyButtonClasses = e.applyButtonClasses), 'string' ==
        typeof e.applyClass &&
        (this.applyButtonClasses = e.applyClass), 'string' ==
        typeof e.cancelButtonClasses &&
        (this.cancelButtonClasses = e.cancelButtonClasses), 'string' ==
        typeof e.cancelClass &&
        (this.cancelButtonClasses = e.cancelClass), 'object' ==
        typeof e.maxSpan && (this.maxSpan = e.maxSpan), 'object' ==
        typeof e.dateLimit && (this.maxSpan = e.dateLimit), 'string' ==
        typeof e.opens && (this.opens = e.opens), 'string' == typeof e.drops &&
        (this.drops = e.drops), 'boolean' == typeof e.showWeekNumbers &&
        (this.showWeekNumbers = e.showWeekNumbers), 'boolean' ==
        typeof e.showISOWeekNumbers &&
        (this.showISOWeekNumbers = e.showISOWeekNumbers), 'string' ==
        typeof e.buttonClasses &&
        (this.buttonClasses = e.buttonClasses), 'object' ==
        typeof e.buttonClasses &&
        (this.buttonClasses = e.buttonClasses.join (' ')), 'boolean' ==
        typeof e.showDropdowns &&
        (this.showDropdowns = e.showDropdowns), 'number' == typeof e.minYear &&
        (this.minYear = e.minYear), 'number' == typeof e.maxYear &&
        (this.maxYear = e.maxYear), 'boolean' ==
        typeof e.showCustomRangeLabel &&
        (this.showCustomRangeLabel = e.showCustomRangeLabel), 'boolean' ==
        typeof e.singleDatePicker &&
        ((this.singleDatePicker = e.singleDatePicker), this.singleDatePicker &&
          (this.endDate = this.startDate.clone ())), 'boolean' ==
        typeof e.timePicker && (this.timePicker = e.timePicker), 'boolean' ==
        typeof e.timePickerSeconds &&
        (this.timePickerSeconds = e.timePickerSeconds), 'number' ==
        typeof e.timePickerIncrement &&
        (this.timePickerIncrement = e.timePickerIncrement), 'boolean' ==
        typeof e.timePicker24Hour &&
        (this.timePicker24Hour = e.timePicker24Hour), 'boolean' ==
        typeof e.autoApply && (this.autoApply = e.autoApply), 'boolean' ==
        typeof e.autoUpdateInput &&
        (this.autoUpdateInput = e.autoUpdateInput), 'boolean' ==
        typeof e.linkedCalendars &&
        (this.linkedCalendars = e.linkedCalendars), 'function' ==
        typeof e.isInvalidDate &&
        (this.isInvalidDate = e.isInvalidDate), 'function' ==
        typeof e.isCustomDate &&
        (this.isCustomDate = e.isCustomDate), 'boolean' ==
        typeof e.alwaysShowCalendars &&
        (this.alwaysShowCalendars = e.alwaysShowCalendars), 0 !=
    ...
    if (
      ...
      (n = r = null), 2 == l.length
        ? ((n = H (l[0], this.locale.format)), (r = H (
            l[1],
            this.locale.format
          )))
        : this.singleDatePicker &&
            '' !== h &&
            ((n = H (h, this.locale.format)), (r = H (
              h,
              this.locale.format
            ))), null !== n &&
        null !== r &&
    ...
    if ('object' == typeof e.ranges) {
      for (o in e.ranges) {
        (n = 'string' == typeof e.ranges[o][0]
          ? H (e.ranges[o][0], this.locale.format)
          : H (e.ranges[o][0])), (r = 'string' == typeof e.ranges[o][1]
          ? H (e.ranges[o][1], this.locale.format)
          : H (e.ranges[o][1])), this.minDate &&
        ...
        if (
          (this.maxSpan &&
            ...
            (c = n.clone ().add (this.maxSpan)), c &&
            r.isAfter (c) &&
            (r = c.clone ()), !((this.minDate &&
      ...
      this.showCustomRangeLabel &&
        (m +=
          ...
          '">' +
          this.locale.customRangeLabel +
          '</li>'), (m += '</ul>'), this.container.find ('.ranges').prepend (m);
    }
    'function' == typeof a && (this.callback = a), this.timePicker ||
      ((this.startDate = this.startDate.startOf (
        'day'
      )), (this.endDate = this.endDate.endOf ('day')), this.container
        .find ('.calendar-time')
        .hide ()), this.timePicker &&
      this.autoApply &&
      (this.autoApply = !1), this.autoApply &&
      this.container.addClass ('auto-apply'), 'object' == typeof e.ranges &&
      this.container.addClass ('show-ranges'), this.singleDatePicker &&
      (this.container.addClass ('single'), this.container
        .find ('.drp-calendar.left')
        .addClass ('single'), this.container
        .find ('.drp-calendar.left')
        .show (), this.container.find ('.drp-calendar.right').hide (), this
        .timePicker || this.container.addClass ('auto-apply')), ((void 0 ===
      e.ranges &&
      !this.singleDatePicker) ||
      this.alwaysShowCalendars) &&
      this.container.addClass ('show-calendar'), this.container.addClass (
      'opens' + this.opens
    ), this.container
      .find ('.applyBtn, .cancelBtn')
      .addClass (this.buttonClasses), this.applyButtonClasses.length &&
      this.container.find ('.applyBtn').addClass (this.applyButtonClasses), this
      .cancelButtonClasses.length &&
      this.container
        .find ('.cancelBtn')
        .addClass (this.cancelButtonClasses), this.container
      .find ('.applyBtn')
      .html (this.locale.applyLabel), this.container
      .find ('.cancelBtn')
      .html (this.locale.cancelLabel), this.container
      .find ('.drp-calendar')
  ...
  return (i.prototype = {
    ...
    setStartDate: function (t) {
      'string' == typeof t &&
        (this.startDate = H (t, this.locale.format)), 'object' == typeof t &&
        (this.startDate = H (t)), this.timePicker ||
        (this.startDate = this.startDate.startOf ('day')), this.timePicker &&
    ...
    setEndDate: function (t) {
      'string' == typeof t &&
        (this.endDate = H (t, this.locale.format)), 'object' == typeof t &&
        (this.endDate = H (t)), this.timePicker ||
        (this.endDate = this.endDate
          .add (1, 'd')
          .startOf ('day')
          .subtract (1, 'second')), this.timePicker &&
        this.timePickerIncrement &&
        this.endDate.minute (
        ...
        this.endDate.isAfter (this.maxDate) &&
        (this.endDate = this.maxDate.clone ()), this.maxSpan &&
        this.startDate.clone ().add (this.maxSpan).isBefore (this.endDate) &&
        (this.endDate = this.startDate
          .clone ()
          .add (
            this.maxSpan
          )), (this.previousRightTime = this.endDate.clone ()), this.container
        .find ('.drp-selected')
        .html (
    ...
    updateView: function () {
      this.timePicker &&
        (this.renderTimePicker ('left'), this.renderTimePicker ('right'), this
          .endDate
          ? this.container
          ...
          : this.container
              .find ('.right .calendar-time select')
              .attr ('disabled', 'disabled')
              .addClass ('disabled')), this.endDate &&
        this.container
          .find ('.drp-selected')
          .html (
            this.startDate.format (this.locale.format) +
    ...
    updateMonthsInView: function () {
      if (this.endDate) {
        if (
          ...
          return;
        (this.leftCalendar.month = this.startDate.clone ().date (2)), this
          .linkedCalendars ||
      ...
      this.maxDate &&
        ...
        ((this.rightCalendar.month = this.maxDate
          .clone ()
          .date (2)), (this.leftCalendar.month = this.maxDate
          .clone ()
          .date (2)
          .subtract (1, 'month')));
    },
    updateCalendars: function () {
      if (this.timePicker) {
        ...
        this.leftCalendar.month
          .hour (t)
          .minute (e)
          .second (a), this.rightCalendar.month.hour (t).minute (e).second (a);
      }
      this.renderCalendar ('left'), this.renderCalendar (
        'right'
      ), this.container.find ('.ranges li').removeClass ('active'), null !=
        this.endDate && this.calculateChosenLabel ();
    },
    renderCalendar: function (t) {
      ...
      for (
        ...
        0 < p && g % 7 == 0 && ((g = 0), y++), (e[y][g] = D.clone ()
          .hour (s)
          .minute (n)
          .second (r)), D.hour (12), this.minDate &&
          e[y][g].format ('YYYY-MM-DD') == this.minDate.format ('YYYY-MM-DD') &&
          e[y][g].isBefore (this.minDate) &&
          'left' == t &&
          (e[y][g] = this.minDate.clone ()), this.maxDate &&
          e[y][g].format ('YYYY-MM-DD') == this.maxDate.format ('YYYY-MM-DD') &&
      ...
      var k = 'left' == t ? this.minDate : this.startDate,
        b = this.maxDate,
        C = ('left' == t ? this.startDate : this.endDate, this.locale
          .direction, '<table class="table-condensed">');
      (C += '<thead>'), (C += '<tr>'), (this.showWeekNumbers ||
        this.showISOWeekNumbers) &&
        (C += '<th></th>'), (k && !k.isBefore (e.firstDay)) ||
      ...
      if (
        ((C += '<th colspan="5" class="month">' + v + '</th>'), (b &&
          !b.isAfter (e.lastDay)) ||
          (this.linkedCalendars && 'right' != t && !this.singleDatePicker)
          ? (C += '<th></th>')
          : (C += '<th class="next available"><span></span></th>'), (C +=
          '</tr>'), (C += '<tr>'), (this.showWeekNumbers ||
          this.showISOWeekNumbers) &&
          (C +=
            '<th class="week">' + this.locale.weekLabel + '</th>'), R.each (
          this.locale.daysOfWeek,
          function (t, e) {
            C += '<th>' + e + '</th>';
          }
        ), (C += '</tr>'), (C += '</thead>'), (C += '<tbody>'), null ==
          this.endDate && this.maxSpan)
      ) {
        var E = this.startDate.clone ().add (this.maxSpan).endOf ('day');
        (b && !E.isBefore (b)) || (b = E);
      }
      for (y = 0; y < 6; y++) {
        (C += '<tr>'), this.showWeekNumbers
          ? (C += '<td class="week">' + e[y][0].week () + '</td>')
          : this.showISOWeekNumbers &&
              (C += '<td class="week">' + e[y][0].isoWeek () + '</td>');
        for (g = 0; g < 7; g++) {
          var W = [];
          e[y][g].isSame (new Date (), 'day') && W.push ('today'), 5 <
            e[y][g].isoWeekday () && W.push ('weekend'), e[y][g].month () !=
            e[1][1].month () && W.push ('off'), this.minDate &&
            e[y][g].isBefore (this.minDate, 'day') &&
            W.push ('off', 'disabled'), b &&
            e[y][g].isAfter (b, 'day') &&
            W.push ('off', 'disabled'), this.isInvalidDate (e[y][g]) &&
            W.push ('off', 'disabled'), e[y][g].format ('YYYY-MM-DD') ==
            this.startDate.format ('YYYY-MM-DD') &&
            W.push ('active', 'start-date'), null != this.endDate &&
            e[y][g].format ('YYYY-MM-DD') ==
              this.endDate.format ('YYYY-MM-DD') &&
            W.push ('active', 'end-date'), null != this.endDate &&
      ...
      (C += '</tbody>'), (C += '</table>'), this.container
      ...
      if ('right' != t || this.endDate) {
        ...
        if (
          (!this.maxSpan ||
            ...
            (s = this.startDate.clone ().add (this.maxSpan)), 'left' == t)
        )
          ...
          if (
            ...
            'PM' === r && a.hour () < 12 && a.hour (a.hour () + 12), 'AM' ===
              r &&
              12 === a.hour () &&
              a.hour (0);
          }
          a.isBefore (this.startDate) && (a = this.startDate.clone ()), s &&
            a.isAfter (s) &&
            (a = s.clone ());
        }
        ...
        for (
          ...
          i && d.minute (59).isBefore (i) && (m = !0), s &&
        ...
        for (l = 0; l < 60; l += this.timePickerIncrement) {
          ...
          i && d.second (59).isBefore (i) && (m = !0), s &&
        ...
        if (!this.timePicker24Hour) {
          ...
          i &&
            ...
            (p = ' disabled="disabled" class="disabled"'), s &&
            a.clone ().hour (0).minute (0).second (0).isAfter (s) &&
            (u = ' disabled="disabled" class="disabled"'), 12 <= a.hour ()
            ? (e +=
                '<option value="AM"' +
                p +
    ...
    show: function (t) {
      this.isShowing ||
        ((this._outsideClickProxy = R.proxy (function (t) {
          ...
          .on ('focusin.daterangepicker', this._outsideClickProxy), R (
          window
        ).on (
        ...
        ), (this.oldStartDate = this.startDate.clone ()), (this.oldEndDate = this.endDate.clone ()), (this.previousRightTime = this.endDate.clone ()), this.updateView (), this.container.show (), this.move (), this.element.trigger (
    ...
    hide: function (t) {
      this.isShowing &&
        (this.endDate ||
          ((this.startDate = this.oldStartDate.clone ()), (this.endDate = this.oldEndDate.clone ())), (this.startDate.isSame (
          this.oldStartDate
        ) &&
          ...
          this.callback (
            ...
            this.endDate.clone (),
            this.chosenLabel
          ), this.updateElement (), R (document).off ('.daterangepicker'), R (
          window
        ).off (
          '.daterangepicker'
        ), this.container.hide (), this.element.trigger (
    ...
    outsideClick: function (t) {
      ...
      'focusin' == t.type ||
        ...
        (this.hide (), this.element.trigger (
    ...
    showCalendars: function () {
      this.container.addClass (
        'show-calendar'
      ), this.move (), this.element.trigger (
        'showCalendar.daterangepicker',
        this
      );
    },
    hideCalendars: function () {
      this.container.removeClass ('show-calendar'), this.element.trigger (
    ...
    clickRange: function (t) {
      ...
      if ((this.chosenLabel = e) == this.locale.customRangeLabel)
        ...
        var a = this.ranges[e];
        (this.startDate = a[0]), (this.endDate = a[1]), this.timePicker ||
          (this.startDate.startOf ('day'), this.endDate.endOf ('day')), this
          .alwaysShowCalendars || this.hideCalendars (), this.clickApply ();
      }
    },
    clickPrev: function (t) {
      R (t.target).parents ('.drp-calendar').hasClass ('left')
        ? (this.leftCalendar.month.subtract (1, 'month'), this
            .linkedCalendars && this.rightCalendar.month.subtract (1, 'month'))
    ...
    clickNext: function (t) {
      R (t.target).parents ('.drp-calendar').hasClass ('left')
        ...
        : (this.rightCalendar.month.add (1, 'month'), this.linkedCalendars &&
            this.leftCalendar.month.add (1, 'month')), this.updateCalendars ();
    },
    ...
    clickDate: function (t) {
      if (R (t.target).hasClass ('available')) {
        ...
        if (this.endDate || s.isBefore (this.startDate, 'day')) {
          ...
          this.setEndDate (s.clone ()), this.autoApply &&
            (this.calculateChosenLabel (), this.clickApply ());
        }
        this.singleDatePicker &&
          (this.setEndDate (this.startDate), this.timePicker ||
            this.clickApply ()), this.updateView (), t.stopPropagation ();
      }
    },
      ...
      for (var a in this.ranges) {
        if (this.timePicker) {
          ...
          if (
            ...
            (t = !1), (this.chosenLabel = this.container
              .find ('.ranges li:eq(' + e + ')')
              .addClass ('active')
              .attr ('data-range-key'));
            break;
      ...
      t &&
        (this.showCustomRangeLabel
          ? (this.chosenLabel = this.container
              ...
              .addClass ('active')
              .attr ('data-range-key'))
          : (this.chosenLabel = null), this.showCalendars ());
    },
    clickApply: function (t) {
      this.hide (), this.element.trigger ('apply.daterangepicker', this);
    },
    clickCancel: function (t) {
      (this.startDate = this.oldStartDate), (this.endDate = this.oldEndDate), this.hide (), this.element.trigger (
    ...
    monthOrYearChanged: function (t) {
      ...
      e ||
        ((n < this.startDate.year () ||
          ...
          ((s = this.startDate.month ()), (n = this.startDate.year ()))), this
        .minDate &&
        (n < this.minDate.year () ||
          (n == this.minDate.year () && s < this.minDate.month ())) &&
        ((s = this.minDate.month ()), (n = this.minDate.year ())), this
        .maxDate &&
        (n > this.maxDate.year () ||
          (n == this.maxDate.year () && s > this.maxDate.month ())) &&
        ((s = this.maxDate.month ()), (n = this.maxDate.year ())), e
        ? (this.leftCalendar.month.month (s).year (n), this.linkedCalendars &&
            (this.rightCalendar.month = this.leftCalendar.month
              .clone ()
              .add (1, 'month')))
        : (this.rightCalendar.month.month (s).year (n), this.linkedCalendars &&
    ...
    timeChanged: function (t) {
      ...
      if (a) {
        ...
        o.hour (i), o.minute (s), o.second (n), this.setStartDate (o), this
          .singleDatePicker
      ...
      this.updateCalendars (), this.updateFormInputs (), this.renderTimePicker (
        'left'
    ...
    elementChanged: function () {
      if (this.element.is ('input') && this.element.val ().length) {
        var t = this.element.val ().split (this.locale.separator),
          ...
          a = null;
        2 === t.length &&
          ((e = H (t[0], this.locale.format)), (a = H (
            t[1],
            this.locale.format
          ))), (this.singleDatePicker || null === e || null === a) &&
          (a = e = H (this.element.val (), this.locale.format)), e.isValid () &&
          a.isValid () &&
          (this.setStartDate (e), this.setEndDate (a), this.updateView ());
      }
    },
    keydown: function (t) {
      (9 !== t.keyCode && 13 !== t.keyCode) || this.hide (), 27 === t.keyCode &&
    ...
    updateElement: function () {
      if (this.element.is ('input') && this.autoUpdateInput) {
        ...
        this.singleDatePicker ||
          (t +=
            this.locale.separator +
            this.endDate.format (this.locale.format)), t !==
          this.element.val () && this.element.val (t).trigger ('change');
      }
    },
    remove: function () {
    ...
    return this.each (function () {
      ...
      t.data ('daterangepicker') &&
        t
          ...
          .remove (), t.data ('daterangepicker', new i (t, a, e));
    }), this;
  }), i;
});
  ...
  (e = (function () {
    function e (e, o) {
      ...
      (n.defaults = {
        ...
        'visibilitychange'), (n.windowWidth = 0), (n.windowTimer = null), (s = i (
        e
      ).data ('slick') || {}), (n.options = i.extend (
        {},
        n.defaults,
        o,
        s
        ...
        ? ((n.hidden = 'mozHidden'), (n.visibilityChange =
            'mozvisibilitychange'))
        : 'undefined' != typeof document.webkitHidden &&
            ((n.hidden = 'webkitHidden'), (n.visibilityChange =
              'webkitvisibilitychange')), (n.autoPlay = i.proxy (
        n.autoPlay,
        n
      )), (n.autoPlayClear = i.proxy (
        n.autoPlayClear,
        n
        ...
        n.swipeHandler,
        n
      )), (n.dragHandler = i.proxy (
        n.dragHandler,
        n
      )), (n.keyHandler = i.proxy (
        n.keyHandler,
        n
    ...
    s.animateHeight (), s.options.rtl === !0 &&
      ...
      : s.cssTransitions === !1
          ? (s.options.rtl === !0 && (s.currentLeft = -s.currentLeft), i ({
              ...
              {animStart: e},
              {
                ...
                step: function (i) {
                  (i = Math.ceil (i)), s.options.vertical === !1
                    ? ((o[s.animType] =
                        'translate(' + i + 'px, 0px)'), s.$slideTrack.css (o))
                    : ((o[s.animType] =
          ...
          : (s.applyTransition (), (e = Math.ceil (e)), s.options.vertical ===
              !1
              ? (o[s.animType] = 'translate3d(' + e + 'px, 0px, 0px)')
              : (o[s.animType] =
                  'translate3d(0px,' + e + 'px, 0px)'), s.$slideTrack.css (
              o
            ), t &&
              setTimeout (function () {
    ...
    i.paused ||
      ...
      (i.options.infinite === !1 &&
        (1 === i.direction && i.currentSlide + 1 === i.slideCount - 1
          ? (i.direction = 0)
          : 0 === i.direction &&
              ((e = i.currentSlide - i.options.slidesToScroll), i.currentSlide -
                1 ===
                0 && (i.direction = 1))), i.slideHandler (e));
    ...
    e.options.arrows === !0 &&
      ((e.$prevArrow = i (e.options.prevArrow).addClass (
        ...
        ? (e.$prevArrow
            ...
            .removeClass ('slick-hidden')
            .removeAttr ('aria-hidden tabindex'), e.htmlExpr.test (
            e.options.prevArrow
          ) &&
            e.$prevArrow.prependTo (e.options.appendArrows), e.htmlExpr.test (
            e.options.nextArrow
          ) && e.$nextArrow.appendTo (e.options.appendArrows), e.options
            .infinite !== !0 &&
            e.$prevArrow
    ...
    if (
      ((o = document.createDocumentFragment ()), (n = l.$slider.children ()), l
        .options.rows > 0)
    ) {
      for (
    ...
    if (
      ('window' === r.respondTo
        ...
        : 'slider' === r.respondTo
            ? (n = d)
            : 'min' === r.respondTo && (n = Math.min (a, d)), r.options
        .responsive &&
      ...
      null !== s
            ...
            ? (s !== r.activeBreakpoint || t) &&
                ((r.activeBreakpoint = s), 'unslick' === r.breakpointSettings[s]
                  ...
                  : ((r.options = i.extend (
                      ...
                      (r.currentSlide = r.options.initialSlide), r.refresh (
                      e
                    )), (l = s))
            : ((r.activeBreakpoint = s), 'unslick' === r.breakpointSettings[s]
                ? r.unslick (s)
        ...
        : null !== r.activeBreakpoint &&
            ((r.activeBreakpoint = null), (r.options =
              r.originalSettings), e === !0 &&
              (r.currentSlide = r.options.initialSlide), r.refresh (
              e
            ), (l = s)), e ||
        l === !1 ||
    ...
    switch ((l.is ('a') && e.preventDefault (), l.is ('li') ||
      (l = l.closest ('li')), (n =
      r.slideCount % r.options.slidesToScroll !== 0), (o = n
      ? 0
      : (r.slideCount - r.currentSlide) % r.options.slidesToScroll), e.data
      .message)) {
      case 'previous':
        (s = 0 === o
    ...
    e.options.dots &&
      ...
      (i ('li', e.$dots)
        ...
        .off ('mouseleave.slick', i.proxy (e.interrupt, e, !1)), e.options
        .accessibility === !0 &&
        e.$dots.off ('keydown.slick', e.keyHandler)), e.$slider.off (
      'focus.slick blur.slick'
    ), e.options.arrows === !0 &&
      e.slideCount > e.options.slidesToShow &&
      (e.$prevArrow &&
        e.$prevArrow.off ('click.slick', e.changeSlide), e.$nextArrow &&
        e.$nextArrow.off ('click.slick', e.changeSlide), e.options
        .accessibility === !0 &&
        (e.$prevArrow &&
          e.$prevArrow.off ('keydown.slick', e.keyHandler), e.$nextArrow &&
          e.$nextArrow.off ('keydown.slick', e.keyHandler))), e.$list.off (
    ...
    var i, e = this;
    e.options.rows > 0 &&
      ((i = e.$slides.children ().children ()), i.removeAttr (
        'style'
    ...
    t.autoPlayClear (), (t.touchObject = {}), t.cleanUpEvents (), i (
      ...
      (t.$prevArrow
        ...
        .css ('display', ''), t.htmlExpr.test (t.options.prevArrow) &&
      ...
      (t.$slides
        ...
        .children (this.options.slide)
        .detach (), t.$slideTrack.detach (), t.$list.detach (), t.$slider.append (
        t.$slides
    ...
    var t = this;
    t.cssTransitions === !1
      ? (t.$slides.eq (i).css ({zIndex: t.options.zIndex}), t.$slides
          .eq (i)
          .animate ({opacity: 1}, t.options.speed, t.options.easing, e))
      : (t.applyTransition (i), t.$slides
          .eq (i)
    ...
    e.cssTransitions === !1
      ...
      : (e.applyTransition (i), e.$slides
          .eq (i)
          .css ({opacity: 0, zIndex: e.options.zIndex - 2}));
  }), (e.prototype.filterSlides = e.prototype.slickFilter = function (i) {
    var e = this;
    null !== i &&
      ((e.$slidesCache = e.$slides), e.unload (), e.$slideTrack
        .children (this.options.slide)
        .detach (), e.$slidesCache
        .filter (i)
    ...
    if (i.options.infinite === !0)
      if (i.slideCount <= i.options.slidesToShow) ++o;
        ...
        for (; e < i.slideCount; )
          ++o, (e = t + i.options.slidesToScroll), (t += i.options
    ...
    return (n.slideOffset = 0), (t = n.$slides.first ().outerHeight (!0)), n
      ...
      ? (n.slideCount > n.options.slidesToShow &&
          ((n.slideOffset =
            n.slideWidth * n.options.slidesToShow * -1), (s = -1), n.options
            .vertical === !0 &&
            n.options.centerMode === !0 &&
            (2 === n.options.slidesToShow
              ? (s = -1.5)
              : 1 === n.options.slidesToShow && (s = -2)), (r =
          ...
          (i > n.slideCount
            ...
            : ((n.slideOffset =
                ...
                n.options.slidesToScroll *
                n.slideWidth *
                -1), (r = n.slideCount % n.options.slidesToScroll * t * -1))))
      : i + n.options.slidesToShow > n.slideCount &&
          ((n.slideOffset =
            (i + n.options.slidesToShow - n.slideCount) * n.slideWidth), (r =
            (i + n.options.slidesToShow - n.slideCount) * t)), n.slideCount <=
      n.options.slidesToShow && ((n.slideOffset = 0), (r = 0)), n.options
      .centerMode === !0 && n.slideCount <= n.options.slidesToShow
      ? (n.slideOffset =
      ...
      : n.options.centerMode === !0 && n.options.infinite === !0
          ? (n.slideOffset +=
              ...
              n.slideWidth)
          : n.options.centerMode === !0 &&
              ((n.slideOffset = 0), (n.slideOffset +=
                n.slideWidth * Math.floor (n.options.slidesToShow / 2))), (e = n
      .options.vertical === !1
      ...
      ((o = n.slideCount <= n.options.slidesToShow || n.options.infinite === !1
        ...
        : n.$slideTrack
            ...
            .eq (i + n.options.slidesToShow)), (e = n.options.rtl === !0
        ? o[0]
            ? (n.$slideTrack.width () - o[0].offsetLeft - o.width ()) * -1
            : 0
        : o[0] ? o[0].offsetLeft * -1 : 0), n.options.centerMode === !0 &&
        ((o = n.slideCount <= n.options.slidesToShow ||
          n.options.infinite === !1
          ? n.$slideTrack.children ('.slick-slide').eq (i)
          : n.$slideTrack
              .children ('.slick-slide')
              .eq (i + n.options.slidesToShow + 1)), (e = n.options.rtl === !0
          ? o[0]
              ? (n.$slideTrack.width () - o[0].offsetLeft - o.width ()) * -1
              : 0
          : o[0] ? o[0].offsetLeft * -1 : 0), (e +=
    ...
    for (
      e.options.infinite === !1
        ? (i = e.slideCount)
        : ((t = e.options.slidesToScroll * -1), (o =
            e.options.slidesToScroll * -1), (i = 2 * e.slideCount));
      t < i;

    )
      s.push (t), (t = o + e.options.slidesToScroll), (o += e.options
    ...
    return (s = n.options.centerMode === !0
      ...
      : 0), (o = n.swipeLeft * -1 + s), n.options.swipeToSlide === !0
      ? (n.$slideTrack.find ('.slick-slide').each (function (e, s) {
          var r, l, d;
          if (
            ((r = i (s).outerWidth ()), (l = s.offsetLeft), n.options
              .centerMode !== !0 && (l += r / 2), (d = l + r), o < d)
          )
            return (t = s), !1;
        }), (e =
    ...
    i (t.$slider).hasClass ('slick-initialized') ||
      (i (t.$slider).addClass (
        'slick-initialized'
      ), t.buildRows (), t.buildOut (), t.setProps (), t.startLoad (), t.loadSlider (), t.initializeEvents (), t.updateArrows (), t.updateDots (), t.checkResponsive (
        !0
      ), t.focusHandler ()), e && t.$slider.trigger ('init', [t]), t.options
      .accessibility === !0 && t.initADA (), t.options.autoplay &&
    ...
    i.options.arrows === !0 &&
      ...
      (i.$prevArrow
        ...
        .off ('click.slick')
        .on ('click.slick', {message: 'next'}, i.changeSlide), i.options
        .accessibility === !0 &&
        (i.$prevArrow.on ('keydown.slick', i.keyHandler), i.$nextArrow.on (
          'keydown.slick',
          i.keyHandler
        )));
    ...
    e.options.dots === !0 &&
      ...
      (i ('li', e.$dots).on (
        ...
        e.$dots.on ('keydown.slick', e.keyHandler)), e.options.dots === !0 &&
    ...
    if (
      (r.options.centerMode === !0
        ? r.options.infinite === !0
            ? ((s = r.currentSlide + (r.options.slidesToShow / 2 + 1)), (n =
                s + r.options.slidesToShow + 2))
            : ((s = Math.max (
                0,
        ...
        : ((s = r.options.infinite
            ...
            : r.currentSlide), (n = Math.ceil (s + r.options.slidesToShow)), r
            .options.fade === !0 &&
            (s > 0 && s--, n <= r.slideCount && n++)), (t = r.$slider
        .find ('.slick-slide')
        .slice (s, n)), 'anticipated' === r.options.lazyLoad)
    )
      for (
    ...
    e (t), r.slideCount <= r.options.slidesToShow
      ...
      : r.currentSlide >= r.slideCount - r.options.slidesToShow
          ? ((o = r.$slider
              .find ('.slick-cloned')
              .slice (0, r.options.slidesToShow)), e (o))
          : 0 === r.currentSlide &&
              ((o = r.$slider
                .find ('.slick-cloned')
                .slice (r.options.slidesToShow * -1)), e (o));
    ...
    if (
      ...
      (t.$slider.trigger ('afterChange', [
        t,
        e,
      ]), (t.animating = !1), t.slideCount > t.options.slidesToShow &&
        t.setPosition (), (t.swipeLeft = null), t.options.autoplay &&
        t.autoPlay (), t.options.accessibility === !0 &&
    ...
    d.length
      ? ((t = d.first ()), (o = t.attr ('data-lazy')), (s = t.attr (
          'data-srcset'
        )), (n =
          t.attr ('data-sizes') ||
          l.$slider.attr ('data-sizes')), (r = document.createElement (
          'img'
        )), (r.onload = function () {
    ...
    var e, t, o = this, s = {};
    o.options.rtl === !0 && (i = -i), (e = 'left' == o.positionProp
      ? Math.ceil (i) + 'px'
      : '0px'), (t = 'top' == o.positionProp
      ? Math.ceil (i) + 'px'
      : '0px'), (s[o.positionProp] = i), o.transformsEnabled === !1
      ? o.$slideTrack.css (s)
      : ((s = {}), o.cssTransitions === !1
          ? ((s[o.animType] =
              'translate(' + e + ', ' + t + ')'), o.$slideTrack.css (s))
          : ((s[o.animType] =
              'translate3d(' + e + ', ' + t + ', 0px)'), o.$slideTrack.css (
              s
            )));
    ...
    (i.positionProp = i.options.vertical === !0 ? 'top' : 'left'), 'top' ===
      ...
      ((i.animType = 'OTransform'), (i.transformType =
        '-o-transform'), (i.transitionType = 'OTransition'), void 0 ===
        e.perspectiveProperty &&
      ...
      ((i.animType = 'webkitTransform'), (i.transformType =
        '-webkit-transform'), (i.transitionType =
        'webkitTransition'), void 0 === e.perspectiveProperty &&
        void 0 === e.webkitPerspective &&
        (i.animType = !1)), void 0 !== e.msTransform &&
      ((i.animType = 'msTransform'), (i.transformType =
        '-ms-transform'), (i.transitionType = 'msTransition'), void 0 ===
        e.msTransform && (i.animType = !1)), void 0 !== e.transform &&
      i.animType !== !1 &&
      ((i.animType = 'transform'), (i.transformType =
        'transform'), (i.transitionType = 'transition')), (i.transformsEnabled =
    ...
    if (
      ((t = n.$slider
        ...
        .attr ('aria-hidden', 'true')), n.$slides
        .eq (i)
        .addClass ('slick-current'), n.options.centerMode === !0)
    ) {
      var r = n.options.slidesToShow % 2 === 0 ? 1 : 0;
      (e = Math.floor (n.options.slidesToShow / 2)), n.options.infinite ===
        !0 &&
        (i >= e && i <= n.slideCount - 1 - e
          ...
          : i === n.slideCount - 1 &&
              t
                ...
                .addClass ('slick-center')), n.$slides
        .eq (i)
        .addClass ('slick-center');
    } else
      i >= 0 && i <= n.slideCount - n.options.slidesToShow
        ...
        : t.length <= n.options.slidesToShow
            ...
            : ((s = n.slideCount % n.options.slidesToShow), (o = n.options
                .infinite === !0
                ? n.options.slidesToShow + i
                : i), n.options.slidesToShow == n.options.slidesToScroll &&
    ...
    var e, t, o, s = this;
    if (
      (s.options.fade === !0 && (s.options.centerMode = !1), s.options
        .infinite === !0 &&
        s.options.fade === !1 &&
    ...
    if (
      ...
      return e === !1 && a.asNavFor (i), (o = i), (d = a.getLeft (
        o
      )), (r = a.getLeft (a.currentSlide)), (a.currentLeft = null ===
        a.swipeLeft
        ? r
        : a.swipeLeft), a.options.infinite === !1 &&
        a.options.centerMode === !1 &&
        (i < 0 || i > a.getDotCount () * a.options.slidesToScroll)
        ? void (a.options.fade === !1 &&
            ((o = a.currentSlide), t !== !0 &&
        ...
        : a.options.infinite === !1 &&
            ...
            ? void (a.options.fade === !1 &&
                ((o = a.currentSlide), t !== !0 &&
                  ...
                  : a.postSlide (o)))
            : (a.options.autoplay && clearInterval (a.autoPlayTimer), (s = o < 0
                ...
                'beforeChange',
                [a, a.currentSlide, s]
              ), (n = a.currentSlide), (a.currentSlide = s), a.setSlideClasses (
                a.currentSlide
              ), a.options.asNavFor &&
                ((l = a.getNavTarget ()), (l = l.slick (
                  'getSlick'
                )), l.slideCount <= l.options.slidesToShow &&
                  l.setSlideClasses (
                    a.currentSlide
                  )), a.updateDots (), a.updateArrows (), a.options.fade === !0
                ? (t !== !0
    ...
    if (
      ((o.interrupted = !1), (o.shouldClick = !(o.touchObject.swipeLength >
        10)), void 0 === o.touchObject.curX)
    )
      return !1;
    if (
      (o.touchObject.edgeHit === !0 &&
        o.$slider.trigger ('edge', [o, o.swipeDirection ()]), o.touchObject
      ...
      'vertical' != t &&
        (o.slideHandler (e), (o.touchObject = {}), o.$slider.trigger ('swipe', [
          o,
          t,
        ]));
    } else
    ...
    if (
      ...
      switch (((e.touchObject.fingerCount = i.originalEvent &&
        ...
        : 1), (e.touchObject.minSwipe =
        e.listWidth / e.options.touchThreshold), e.options.verticalSwiping ===
        !0 &&
        (e.touchObject.minSwipe = e.listHeight / e.options.touchThreshold), i
        .data.action)) {
        case 'start':
          e.swipeStart (i);
          break;
    ...
    return (n = void 0 !== i.originalEvent
      ...
      ((e = l.getLeft (l.currentSlide)), (l.touchObject.curX = void 0 !== n
        ? n[0].pageX
        : i.clientX), (l.touchObject.curY = void 0 !== n
        ? n[0].pageY
        ...
        : (l.options.verticalSwiping === !0 &&
            ...
            ((l.swiping = !0), i.preventDefault ()), (s =
            (l.options.rtl === !1 ? 1 : -1) *
            (l.touchObject.curX > l.touchObject.startX ? 1 : -1)), l.options
            .verticalSwiping === !0 &&
            (s = l.touchObject.curY > l.touchObject.startY ? 1 : -1), (o =
            l.touchObject.swipeLength), (l.touchObject.edgeHit = !1), l.options
            .infinite === !1 &&
            ((0 === l.currentSlide && 'right' === t) ||
              (l.currentSlide >= l.getDotCount () && 'left' === t)) &&
            ((o =
              l.touchObject.swipeLength *
              l.options.edgeFriction), (l.touchObject.edgeHit = !0)), l.options
            .vertical === !1
            ? (l.swipeLeft = e + o * s)
            : (l.swipeLeft = e + o * (l.$list.height () / l.listWidth) * s), l
            .options.verticalSwiping === !0 && (l.swipeLeft = e + o * s), l
            .options.fade !== !0 &&
    ...
    return (t.interrupted = !0), 1 !== t.touchObject.fingerCount ||
      ...
      : (void 0 !== i.originalEvent &&
          ...
          (e =
            i.originalEvent
              .touches[0]), (t.touchObject.startX = t.touchObject.curX = void 0 !==
          e
          ? e.pageX
          : i.clientX), (t.touchObject.startY = t.touchObject.curY = void 0 !==
          e
          ? e.pageY
          : i.clientY), void (t.dragging = !0));
    ...
    for (i = 0; i < r; i++)
      if (
        ('object' == typeof s || 'undefined' == typeof s
          ...
          : (t = o[i].slick[s].apply (o[i].slick, n)), 'undefined' != typeof t)
      )
        return t;
    return o;
  });
...
!(function (t) {
  ...
  var e = -1,
    ...
    r = (t.fn.matchHeight = function (e) {
      ...
      return this.length <= 1 && !o.target
        ? this
        : (r._groups.push ({elements: this, options: o}), r._apply (
            this,
            o
          ), this);
    });
  (r.version =
    '0.7.2'), (r._groups = []), (r._throttle = 80), (r._maintainScroll = !1), (r._beforeUpdate = null), (r._afterUpdate = null), (r._rows = a), (r._parse = n), (r._parseOptions = i), (r._apply = function (
    e,
    o
  ) {
    var s = i (o),
    ...
    return u.each (function () {
      ...
      (h.each (function () {
        ...
        'inline-block' !== o &&
          'flex' !== o &&
          'inline-flex' !== o &&
          (o = 'block'), e.data ('style-cache', e.attr ('style')), e.css ({
          display: o,
          'padding-top': '0',
          'padding-bottom': '0',
          'margin-top': '0',
      ...
      if (s.target) i = s.target.outerHeight (!1);
        ...
        a.each (function () {
          ...
          (a[s.property] =
            ''), e.css (a), e.outerHeight (!1) > i && (i = e.outerHeight (!1)), o ? e.attr ('style', o) : e.css ('display', '');
        });
      }
      a.each (function () {
        var e = t (this), o = 0;
      ...
      t (window).scrollTop (c / p * t ('html').outerHeight (!0)), this;
  ...
  var s = function (e) {
    r._beforeUpdate &&
      r._beforeUpdate (e, r._groups), t.each (r._groups, function () {
...
).insertAfter ('.quantity input'), $ ('.quantity').each (function () {
  var t = jQuery (this),
    ...
    var s = {},
      ...
      o = function (t, r) {
        for (
          (numValue = ''), (numOpts = [
            ...
            ''), (symLoc = -1), (decPlaces = 0), (sepOpts = s.decimalOpts.concat (
            s.thousandOpts
          )), (z = t.length - 1);
          z >= 0;
          z--
        )
          (ch = t.charAt (z)), -1 != e.inArray (ch, numOpts)
            ...
            : '' == dec && -1 != e.inArray (ch, s.decimalOpts)
                ...
                : '' == thou && -1 != e.inArray (ch, s.thousandOpts)
                    ...
                    : '' != sym ||
                        ...
                        ((sym = ch), (symLoc = z));
        return '' != dec &&
          ((decPlaces = t.length - decLoc - 1), symLoc > decLoc &&
            decPlaces--), -1 != s.decimalPlaces &&
          (decPlaces = s.decimalPlaces), 2 == arguments.length &&
          ('' == r.dec && '' != dec && (r.dec = dec), ((-1 == r.decPlaces &&
            -1 != decPlaces) ||
            (-1 != r.decPlaces &&
              -1 != decPlaces &&
              decPlaces < r.decPlaces)) &&
            (r.decPlaces = decPlaces), '' == r.thou &&
            '' != thou &&
            (r.thou = thou), '' == r.sym &&
            '' != sym &&
            ((r.sym = sym), (r.symLoc = symLoc))), s.emptyAsZero &&
          '' == numValue &&
          (numValue = '0'), numValue;
      },
      d = function (t, n, c, a) {
        ...
        for (func in u)
          for (
            ...
            (v = f.exec (m[1], a, d)), (t = t.replace (
              new RegExp (f.rgx, 'gi'),
              v
            ));
        for (i = 0; i < n.length; i++) {
          if (
            ((field = n[i]), (fieldValue = e (
              l (field),
              a
            ).val ()), (numValue = o (fieldValue, d)), 0 == numValue.length)
          )
            return void c.val ('').change ();
          t = t.replace (new RegExp ('{' + field + '}', 'g'), numValue);
        }
        (t = t.replace (/ /g, '')), '' == d.dec &&
          (d.dec = s.decimalOpts[0]), -1 == d.decPlaces &&
          (d.decPlaces = 0), '' == d.thou &&
          (d.thou = s.thousandOpts[0]), (resultValue = $ (t)), null ==
          resultValue
          ? (resultValue = '')
          : (resultValue = h (
              resultValue,
          ...
          /\<c\>/g,
          d.dec
        )), (resultValue = resultValue.replace (/\<t\>/g, d.thou)), d.symLoc >
          -1 &&
          (0 == d.symLoc
            ? (resultValue = d.sym + resultValue)
            : (resultValue += d.sym)), s.smartIntegers &&
          (resultValue = resultValue.replace (/[\,\.]0+$/, '')), e.isFunction (
          s.onShowResult
        ) && (resultValue = s.onShowResult.call (this, c, resultValue)), c.val (
          resultValue
        ), s.chainFire && c.change ();
      },
      h = function (e, t) {
        for (
          (n = e.toFixed (t) + ''), (x = n.split ('.')), (x1 =
            x[0]), (x2 = x.length > 1
            ? '.' + x[1]
            : ''), (rgx = /(\d+)(\d{3})/);
          rgx.test (x1);
      ...
      y = function (e) {
        ...
        if ((r = /^[a-z_][a-z0-9_]*/i.exec (e.string.substr (e.offset)))) {
          ...
          throw ((e.error =
            "Semantic error: unknown variable '" + s + "'"), 'unknownVar');
        }
        throw e.string.length == e.offset
          ? ((e.error =
              'Parsing error at end of string: value expected'), 'valueMissing')
        ...
        try {
          ...
          if (t.offset < t.string.length)
            throw ((t.error =
              ...
              t.offset), 'trailingJunk');
          return r;
        } catch (n) {
          return void (s.showParseError &&
            alert (
              t.error +
                ' (' +
                n +
      ...
      j = {
        init: function () {
          return this.each (function () {
            ($ctx = e (this)), e (
              '[' + s.attribute + ']:not([_jac])',
              $ctx
            ).each (function () {
              if (
                (($this = e (this)), (eq = $this.attr (
                  s.attribute
                )), (fields = a (eq)), 0 != fields.length)
              ) {
                for (i = 0; i < fields.length; i++)
                  if (0 == e (l (fields[i]), $ctx).length) return;
                for (
                  (field = ''), (name = $this.attr ('name')), (fireEvents =
                    'focus.jautocalc change.jautocalc blur.jautocalc'), s.keyEventsFire &&
                    (fireEvents +=
                      ' keyup.jautocalc keydown.jautocalc keypress.jautocalc'), (i = 0);
                  i < fields.length;
                  i++
                )
                  (field = fields[i]), e (l (field), $ctx).bind (
                    fireEvents,
                    {
                      equation: eq,
                ...
                s.readOnlyResults && $this.attr ('readonly', !0), $this.attr (
                  '_jac',
                  '_jac'
            ...
            ($ctx = e (this)), e (
              ...
              if (
                ...
                for ((field = ''), (i = 0); i < fields.length; i++)
                  (field = fields[i]), e (l (field), $ctx).unbind (
                    '.jautocalc'
                  );
                s.readOnlyResults &&
                  $this.removeAttr ('readonly'), $this.removeAttr ('_jac');
              }
            });
          });
        },
...
!(function (t, e) {
  ...
  function h (t, e, i, r, l) {
    ...
    (t.reach[
      h
    ] = null), f[s] < 1 && (t.reach[h] = 'start'), f[s] > t[n] - t[o] - 1 && (t.reach[h] = 'end'), e && (f.dispatchEvent (c ('ps-scroll-' + h)), e < 0 ? f.dispatchEvent (c ('ps-scroll-' + u)) : e > 0 && f.dispatchEvent (c ('ps-scroll-' + d)), r && a (t, h)), t.reach[h] && (e || l) && f.dispatchEvent (c ('ps-' + h + '-reach-' + t.reach[h]));
  }
  function u (t) {
  ...
  function b (t, i) {
    ...
    i.isRtl
      ? (r.left =
          ...
          i.contentWidth)
      : (r.left =
          t.scrollLeft), i.isScrollbarXUsingBottom ? (r.bottom = i.scrollbarXBottom - l) : (r.top = i.scrollbarXTop + l), e (i.scrollbarXRail, r);
    ...
    i.isScrollbarYUsingRight
      ...
      : i.isRtl
          ...
          : (n.left =
              i.scrollbarYLeft +
              t.scrollLeft), e (i.scrollbarYRail, n), e (i.scrollbarX, {left: i.scrollbarXLeft, width: i.scrollbarXWidth - i.railBorderXWidth}), e (i.scrollbarY, {top: i.scrollbarYTop, height: i.scrollbarYHeight - i.railBorderYWidth});
  }
  function g (t, e) {
    function i (e) {
      (b[d] =
        ...
        Y *
          (e[a] -
            v)), o (t, f), R (t), e.stopPropagation (), e.preventDefault ();
    }
    function r () {
      s (
        t,
        f
      ), t[p].classList.remove (m.state.clicking), t.event.unbind (t.ownerDocument, 'mousemove', i);
    }
    var l = e[0],
      n = e[1],
      a = e[2],
    ...
    t.event.bind (t[h], 'mousedown', function (e) {
      (g =
        b[
          d
        ]), (v = e[a]), (Y = (t[n] - t[l]) / (t[c] - t[u])), t.event.bind (t.ownerDocument, 'mousemove', i), t.event.once (t.ownerDocument, 'mouseup', r), t[p].classList.add (m.state.clicking), e.stopPropagation (), e.preventDefault ();
    });
  }
  var v =
  ...
  (X.prototype.bind = function (t, e) {
    void 0 === this.handlers[t] && (this.handlers[t] = []), this.handlers[
      t
  ...
  var W = function (t, e, i, r, l) {
    ...
    R = function (t) {
      ...
      (t.containerWidth = e.clientWidth), (t.containerHeight =
        e.clientHeight), (t.contentWidth = e.scrollWidth), (t.contentHeight =
        e.scrollHeight), e.contains (t.scrollbarXRail) ||
        (n (e, m.element.rail ('x')).forEach (function (t) {
          return l (t);
        }), e.appendChild (t.scrollbarXRail)), e.contains (t.scrollbarYRail) ||
        ...
        ? ((t.scrollbarXActive = !0), (t.railXWidth =
            t.containerWidth - t.railXMarginWidth), (t.railXRatio =
            t.containerWidth / t.railXWidth), (t.scrollbarXWidth = p (
            t,
        ...
        ? ((t.scrollbarYActive = !0), (t.railYHeight =
            ...
            t.containerHeight / t.railYHeight), (t.scrollbarYHeight = p (
            t,
        ...
        : (t.scrollbarYActive = !1), t.scrollbarXLeft >=
        t.railXWidth - t.scrollbarXWidth &&
        (t.scrollbarXLeft =
          t.railXWidth - t.scrollbarXWidth), t.scrollbarYTop >=
        t.railYHeight - t.scrollbarYHeight &&
        (t.scrollbarYTop = t.railYHeight - t.scrollbarYHeight), b (
        e,
        t
      ), t.scrollbarXActive
        ...
        : (e.classList.remove (
            m.state.active ('x')
          ), (t.scrollbarXWidth = 0), (t.scrollbarXLeft = 0), (e.scrollLeft = 0)), t.scrollbarYActive
    ...
    T = {
      'click-rail': function (t) {
        t.event.bind (t.scrollbarY, 'mousedown', function (t) {
          ...
          var i = e.pageY -
            ...
            : -1;
          (t.element.scrollTop +=
            i * t.containerHeight), R (t), e.stopPropagation ();
          ...
          (t.element.scrollLeft +=
            i * t.containerWidth), R (t), e.stopPropagation ();
        });
      },
          ...
          if (
            ...
            switch (r.which) {
              case 37:
                s = r.metaKey
                  ? -t.contentWidth
                  : r.altKey ? -t.containerWidth : -30;
                break;
              case 38:
                a = r.metaKey
                  ? t.contentHeight
                  : r.altKey ? t.containerHeight : 30;
                break;
              case 39:
                s = r.metaKey
                  ? t.contentWidth
            ...
            (t.settings.suppressScrollX && 0 !== s) ||
              ...
              ((i.scrollTop -= a), (i.scrollLeft += s), R (t), e (s, a) &&
                r.preventDefault ());
          }
        });
      },
      wheel: function (e) {
        ...
        function r (t) {
          ...
          return (void 0 !== e && void 0 !== i) ||
            ((e = -1 * t.wheelDeltaX / 6), (i =
              t.wheelDeltaY / 6)), t.deltaMode &&
            1 === t.deltaMode &&
            ((e *= 10), (i *= 10)), e !== e &&
            i !== i &&
            ...
            e.settings.useBothWheelAxes
              ? e.scrollbarYActive && !e.scrollbarXActive
                  ? (a
                      ...
                      : (o.scrollTop += s * e.settings.wheelSpeed), (c = !0))
                  : e.scrollbarXActive &&
                      !e.scrollbarYActive &&
                      (s
                        ? (o.scrollLeft += s * e.settings.wheelSpeed)
                        : (o.scrollLeft -= a * e.settings.wheelSpeed), (c = !0))
              : ((o.scrollTop -= a * e.settings.wheelSpeed), (o.scrollLeft +=
                  s * e.settings.wheelSpeed)), R (e), (c = c || i (s, a)) &&
              !t.ctrlKey &&
      ...
      touch: function (e) {
        ...
        function o (t) {
          if (n (t)) {
            var e = l (t);
            (u.pageX = e.pageX), (u.pageY =
              e.pageY), (d = new Date ().getTime ()), null !== p &&
              clearInterval (p);
          }
        }
        function s (e, i, r) {
        ...
        if (L.supportsTouch || L.supportsIePointer) {
          ...
          L.supportsTouch
            ? (e.event.bind (h, 'touchstart', o), e.event.bind (
                h,
                'touchmove',
                a
            ...
            : L.supportsIePointer &&
                (window.PointerEvent
                  ? (e.event.bind (h, 'pointerdown', o), e.event.bind (
                      h,
                      'pointermove',
                      a
                    ), e.event.bind (h, 'pointerup', c))
                  : window.MSPointerEvent &&
                      (e.event.bind (h, 'MSPointerDown', o), e.event.bind (
                        h,
                        'MSPointerMove',
                        a
    ...
    H = function (r, l) {
      var n = this;
      if (
        (void 0 === l && (l = {}), 'string' == typeof r &&
          (r = document.querySelector (r)), !r || !r.nodeName)
      )
        throw new Error (
      ...
      (this.isRtl =
        'rtl' === t (r).direction), (this.isNegativeScroll = (function () {
        var t = r.scrollLeft, e = null;
        return (r.scrollLeft = -1), (e =
          r.scrollLeft < 0), (r.scrollLeft = t), e;
      }) ()), (this.negativeScrollAdjustment = this.isNegativeScroll
        ? r.scrollWidth - r.clientWidth
        : 0), (this.event = new y ()), (this.ownerDocument =
        r.ownerDocument || document), (this.scrollbarXRail = i (
        m.element.rail ('x')
      )), r.appendChild (this.scrollbarXRail), (this.scrollbarX = i (
        m.element.thumb ('x')
      )), this.scrollbarXRail.appendChild (
        this.scrollbarX
      ), this.scrollbarX.setAttribute ('tabindex', 0), this.event.bind (
        this.scrollbarX,
        'focus',
        s
      ), this.event.bind (
        ...
        'blur',
        a
      ), (this.scrollbarXActive = null), (this.scrollbarXWidth = null), (this.scrollbarXLeft = null);
      var c = t (this.scrollbarXRail);
      (this.scrollbarXBottom = parseInt (c.bottom, 10)), isNaN (
        this.scrollbarXBottom
      )
        ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = u (
            c.top
          )))
        : (this.isScrollbarXUsingBottom = !0), (this.railBorderXWidth =
        u (c.borderLeftWidth) + u (c.borderRightWidth)), e (
        this.scrollbarXRail,
        {display: 'block'}
      ), (this.railXMarginWidth = u (c.marginLeft) + u (c.marginRight)), e (
        this.scrollbarXRail,
        {display: ''}
      ), (this.railXWidth = null), (this.railXRatio = null), (this.scrollbarYRail = i (
        m.element.rail ('y')
      )), r.appendChild (this.scrollbarYRail), (this.scrollbarY = i (
        m.element.thumb ('y')
      )), this.scrollbarYRail.appendChild (
        this.scrollbarY
      ), this.scrollbarY.setAttribute ('tabindex', 0), this.event.bind (
        this.scrollbarY,
        'focus',
        s
      ), this.event.bind (
      ...
      (this.scrollbarYRight = parseInt (h.right, 10)), isNaN (
        this.scrollbarYRight
      )
        ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = u (
            h.left
          )))
        : (this.isScrollbarYUsingRight = !0), (this.scrollbarYOuterWidth = this
        .isRtl
        ? f (this.scrollbarY)
        : null), (this.railBorderYWidth =
        u (h.borderTopWidth) + u (h.borderBottomWidth)), e (
        this.scrollbarYRail,
        {display: 'block'}
      ), (this.railYMarginHeight =
        u (h.marginTop) + u (h.marginBottom)), e (this.scrollbarYRail, {
        display: '',
        ...
        r.scrollTop
      )), (this.lastScrollLeft = r.scrollLeft), this.event.bind (
        this.element,
        'scroll',
        function (t) {
          return n.onScroll (t);
  ...
  return (H.prototype.update = function () {
    this.isAlive &&
      ((this.negativeScrollAdjustment = this.isNegativeScroll
        ...
        : 0), e (this.scrollbarXRail, {display: 'block'}), e (
        this.scrollbarYRail,
        {display: 'block'}
      ), (this.railXMarginWidth =
        u (t (this.scrollbarXRail).marginLeft) +
        u (t (this.scrollbarXRail).marginRight)), (this.railYMarginHeight =
        u (t (this.scrollbarYRail).marginTop) +
        u (t (this.scrollbarYRail).marginBottom)), e (this.scrollbarXRail, {
        display: 'none',
      }), e (this.scrollbarYRail, {display: 'none'}), R (this), W (
        this,
        'top',
        0,
        !1,
        !0
      ), W (this, 'left', 0, !1, !0), e (this.scrollbarXRail, {
        display: '',
    ...
    this.isAlive &&
      (this.event.unbindAll (), l (this.scrollbarX), l (this.scrollbarY), l (
        this.scrollbarXRail
      ), l (
        this.scrollbarYRail
      ), this.removePsClasses (), (this.element = null), (this.scrollbarX = null), (this.scrollbarY = null), (this.scrollbarXRail = null), (this.scrollbarYRail = null), (this.isAlive = !1));
      ...
      e (1), (function (t) {
        ...
        t.fn.iqDropdown = function (e) {
          ...
          function r (n, e, o) {
            ...
            return e
              .children ('div')
              .addClass (u.controls.displayCls), r.append (i, a, s), 'right' ===
              u.controls.position
              ? e.append (r)
              : e.prepend (r), i.click (function (t) {
              var e = u.items,
                r = u.minItems,
                i = u.beforeDecrement,
                s = u.onChange,
...
(function (f) {
  ...
  var q = function (a, b, d) {
    ...
    a !== p &&
      ...
      ((a = a.split (
        ...
        a[1] == +a[1] &&
        (a[1] = +a[1]), b && b.values && b.values.length
        ? ((d.from = a[0] && b.values.indexOf (a[0])), (d.to =
            a[1] && b.values.indexOf (a[1])))
  ...
  q.prototype = {
    ...
    append: function () {
      ...
      'single' === this.options.type
        ? (this.$cache.cont.append (
            ...
            '.irs-bar-edge'
          )), (this.$cache.s_single = this.$cache.cont.find (
            '.single'
          )), (this.$cache.from[0].style.visibility =
            'hidden'), (this.$cache.to[0].style.visibility =
            'hidden'), (this.$cache.shad_single = this.$cache.cont.find (
            '.shadow-single'
          )))
        : (this.$cache.cont.append (
          ...
          ), (this.$cache.s_from = this.$cache.cont.find (
            '.from'
          )), (this.$cache.s_to = this.$cache.cont.find (
            '.to'
      ...
      this.options.hide_from_to &&
        ((this.$cache.from[0].style.display =
          'none'), (this.$cache.to[0].style.display =
    ...
    pointerFocus: function (a) {
      if (!this.target) {
        var b = 'single' === this.options.type
          ? this.$cache.single
          : this.$cache.from;
        a = b.offset ().left;
        a += b.width () / 2 - 1;
    ...
    pointerUp: function (a) {
      this.current_plugin === this.plugin_count &&
        this.is_active &&
        ((this.is_active = !1), this.$cache.cont
          .find ('.state_hover')
          .removeClass ('state_hover'), (this.force_redraw = !0), m &&
          f ('*').prop (
            'unselectable',
            !1
          ), this.updateScene (), this.restoreOriginalMinInterval (), (f.contains (
          this.$cache.cont[0],
          a.target
        ) ||
          this.dragging) &&
    ...
    pointerDown: function (a, b) {
      ...
      2 !== b.button &&
        ('both' === a && this.setTempMinInterval (), a ||
          (a =
            this.target ||
            'from'), (this.current_plugin = this.plugin_count), (this.target = a), (this.dragging = this.is_active = !0), (this.coords.x_gap = this.$cache.rs.offset ().left), (this.coords.x_pointer =
          d - this.coords.x_gap), this.calcPointerPercent (), this.changeLevel (
          a
        ), m && f ('*').prop ('unselectable', !0), this.$cache.line.trigger (
          'focus'
        ), this.updateScene ());
    },
    pointerClick: function (a, b) {
      ...
      var d =
        ...
        (b.originalEvent.touches && b.originalEvent.touches[0].pageX);
      2 !== b.button &&
        ((this.current_plugin = this.plugin_count), (this.target = a), (this.is_click = !0), (this.coords.x_gap = this.$cache.rs.offset ().left), (this.coords.x_pointer = +(d -
          this.coords
    ...
    calc: function (a) {
      if (this.options) {
        ...
        if (10 === this.calc_count || a)
          (this.calc_count = 0), (this.coords.w_rs = this.$cache.rs.outerWidth (
            !1
        ...
        if (this.coords.w_rs) {
          ...
          'click' === this.target &&
            ((this.coords.p_gap =
              ...
              2), (a = this.getHandleX ()), (this.target = this.options
              .drag_interval
              ? 'both_one'
              : this.chooseHandle (a)));
          switch (this.target) {
          ...
          'single' === this.options.type
            ? ((this.coords.p_bar_x =
                this.coords.p_handle /
                2), (this.coords.p_bar_w = this.coords.p_single_fake), (this.result.from_percent = this.coords.p_single_real), (this.result.from = this.convertToValue (
                this.coords.p_single_real
            ...
            : ((this.coords.p_bar_x = this.toFixed (
              ...
              )), (this.result.from_percent = this.coords.p_from_real), (this.result.from = this.convertToValue (
                this.coords.p_from_real
              )), (this.result.from_pretty = this._prettify (
                this.result.from
              )), (this.result.to_percent = this.coords.p_to_real), (this.result.to = this.convertToValue (
                this.coords.p_to_real
      ...
      this.coords.w_rs
        ? (0 > this.coords.x_pointer || isNaN (this.coords.x_pointer)
            ...
            : this.coords.x_pointer > this.coords.w_rs &&
                (this.coords.x_pointer = this.coords.w_rs), (this.coords.p_pointer = this.toFixed (
    ...
    calcHandlePercent: function () {
      this.coords.w_handle = 'single' === this.options.type
    ...
    calcMinMax: function () {
      this.coords.w_rs &&
        ((this.labels.p_min =
          this.labels.w_min / this.coords.w_rs * 100), (this.labels.p_max =
      ...
      this.coords.w_rs &&
        ...
        ('single' === this.options.type
          ...
          : ((this.labels.w_from = this.$cache.from.outerWidth (
              ...
              this.coords.p_handle / 2 -
              this.labels.p_from_fake /
                2), (this.labels.p_from_left = this.toFixed (
              this.labels.p_from_left
            )), (this.labels.p_from_left = this.checkEdges (
              this.labels.p_from_left,
              this.labels.p_from_fake
            )), (this.labels.w_to = this.$cache.to.outerWidth (
              !1
            )), (this.labels.p_to_fake =
              this.labels.w_to /
              this.coords.w_rs *
              100), (this.labels.p_to_left =
              this.coords.p_to_fake +
              this.coords.p_handle / 2 -
              this.labels.p_to_fake /
                2), (this.labels.p_to_left = this.toFixed (
              ...
              (this.labels.p_from_left +
                ...
                2 -
              this.labels.p_single_fake /
                2), (this.labels.p_single_left = this.toFixed (
    ...
    drawHandles: function () {
      ...
      if (this.coords.w_rs) {
        ...
        if (this.coords.w_rs !== this.coords.w_rs_old || this.force_redraw)
          this.setMinMax (), this.calc (!0), this.drawLabels (), this.options
            .grid &&
            (this.calcGridMargin (), this.calcGridLabels ()), (this.force_redraw = !0), (this.coords.w_rs_old = this.coords.w_rs), this.drawShadow ();
        if (
          this.coords.w_rs &&
          ...
          if (
            ...
            (this.old_from === this.result.from &&
              this.old_to === this.result.to) ||
              this.is_start ||
              (this.$cache.input.trigger ('change'), this.$cache.input.trigger (
                'input'
              ));
            this.old_from = this.result.from;
            this.old_to = this.result.to;
    ...
    drawLabels: function () {
      if (this.options) {
        var a = this.options.values.length, b = this.options.p_values;
        if (!this.options.hide_from_to)
          if ('single' === this.options.type) {
            ...
            this.calcLabels ();
            this.$cache.min[0].style.visibility = this.labels.p_single_left <
              this.labels.p_min + 1
              ? 'hidden'
              : 'visible';
            this.$cache.max[0].style.visibility = this.labels.p_single_left +
              this.labels.p_single_fake >
            ...
            a
              ? (this.options.decorate_both
                  ? ((a = this.decorate (b[this.result.from])), (a += this
                      .options.values_separator), (a += this.decorate (
                      b[this.result.to]
                    )))
                  : (a = this.decorate (
                      b[this.result.from] +
              ...
              : ((d = this._prettify (this.result.from)), (b = this._prettify (
                  this.result.to
                )), this.options.decorate_both
                  ? ((a = this.decorate (d, this.result.from)), (a += this
                      .options.values_separator), (a += this.decorate (
                      b,
                      this.result.to
                    )))
            ...
            this.labels.p_from_left + this.labels.p_from_fake >=
              ...
              ? ((this.$cache.from[0].style.visibility =
                  'hidden'), (this.$cache.to[0].style.visibility =
                  'hidden'), (this.$cache.single[0].style.visibility =
                  'visible'), this.result.from === this.result.to
                  ? ('from' === this.target
                  ...
                  : ((this.$cache.from[0].style.visibility =
                      'hidden'), (this.$cache.to[0].style.visibility =
                      'hidden'), (this.$cache.single[0].style.visibility =
                      'visible'), (c = Math.max (d, b))))
              : ((this.$cache.from[0].style.visibility =
                  'visible'), (this.$cache.to[0].style.visibility =
                  'visible'), (this.$cache.single[0].style.visibility =
                  'hidden'));
            this.$cache.min[0].style.visibility = a < this.labels.p_min + 1
              ? 'hidden'
              : 'visible';
            this.$cache.max[0].style.visibility = c >
              100 - this.labels.p_max - 1
              ? 'hidden'
              : 'visible';
          }
    ...
    drawShadow: function () {
      ...
      'single' === a.type
        ? a.from_shadow && (d || c)
            ? ((d = this.convertToPercent (d ? a.from_min : a.min)), (c =
                this.convertToPercent (c ? a.from_max : a.max) -
                d), (d = this.toFixed (
                d - this.coords.p_handle / 100 * d
              )), (c = this.toFixed (c - this.coords.p_handle / 100 * c)), (d +=
                this.coords.p_handle / 2), (b.shad_single[0].style.display =
                'block'), (b.shad_single[0].style.left =
                d + '%'), (b.shad_single[0].style.width = c + '%'))
        ...
        : (a.from_shadow && (d || c)
            ? ((d = this.convertToPercent (d ? a.from_min : a.min)), (c =
                ...
                'block'), (b.shad_from[0].style.left =
                d + '%'), (b.shad_from[0].style.width = c + '%'))
            : (b.shad_from[0].style.display = 'none'), a.to_shadow && (e || g)
            ? ((e = this.convertToPercent (e ? a.to_min : a.min)), (a =
                this.convertToPercent (g ? a.to_max : a.max) -
                e), (e = this.toFixed (
                e - this.coords.p_handle / 100 * e
              )), (a = this.toFixed (a - this.coords.p_handle / 100 * a)), (e +=
                this.coords.p_handle / 2), (b.shad_to[0].style.display =
                'block'), (b.shad_to[0].style.left =
                e + '%'), (b.shad_to[0].style.width = a + '%'))
    ...
    convertToValue: function (a) {
      ...
      g && l && (f = g >= l ? g : l);
      0 > b &&
        ((h = Math.abs (b)), (b = +(b + h).toFixed (f)), (d = +(d + h).toFixed (
          f
        )));
      a = (d - b) / 100 * a + b;
      (b = this.options.step.toString ().split ('.')[1])
        ? (a = +a.toFixed (b.length))
        : ((a /= this.options.step), (a *= this.options.step), (a = +a.toFixed (
            0
          )));
      h && (a -= h);
    ...
    validate: function () {
      ...
      if (c)
        for (
          (a.p_values = []), (a.min = 0), (a.max =
            c - 1), (a.step = 1), (a.grid_num =
            a.max), (a.grid_snap = !0), (e = 0);
          e < c;
          e++
        ) {
          var g = +d[e];
      ...
      'single' === a.type
        ? (a.from < a.min && (a.from = a.min), a.from > a.max &&
            (a.from = a.max))
        : (a.from < a.min && (a.from = a.min), a.from > a.max &&
            (a.from = a.max), a.to < a.min && (a.to = a.min), a.to > a.max &&
            (a.to = a.max), this.update_check.from &&
            (this.update_check.from !== a.from &&
              a.from > a.to &&
              (a.from = a.to), this.update_check.to !== a.to &&
              a.to < a.from &&
              (a.to = a.from)), a.from > a.to && (a.from = a.to), a.to <
            a.from && (a.to = a.from));
    ...
    calcGridLabels: function () {
      ...
      this.options.force_edges &&
        (b[0] < -this.coords.grid_gap &&
          ((b[0] = -this.coords.grid_gap), (d[0] = this.toFixed (
            b[0] + this.coords.big_p[0]
          )), (this.coords.big_x[0] = this.coords.grid_gap)), d[c - 1] >
          100 + this.coords.grid_gap &&
          ((d[c - 1] = 100 + this.coords.grid_gap), (b[c - 1] = this.toFixed (
      ...
      for (a = 0; a < c; a++)
        (b = this.$cache.grid_labels[a][0]), this.coords.big_x[a] !==
    ...
    calcGridMargin: function () {
      this.options.grid_margin &&
        ((this.coords.w_rs = this.$cache.rs.outerWidth (!1)), this.coords
          .w_rs &&
          ((this.coords.w_handle = 'single' === this.options.type
            ? this.$cache.s_single.outerWidth (!1)
            : this.$cache.s_from.outerWidth (
                !1
              )), (this.coords.p_handle = this.toFixed (
            this.coords.w_handle / this.coords.w_rs * 100
    ...
    update: function (a) {
      this.input &&
        ((this.is_update = !0), (this.options.from = this.result.from), (this.options.to = this.result.to), (this.update_check.from = this.result.from), (this.update_check.to = this.result.to), (this.options = f.extend (
          this.options,
          a
        )), this.validate (), this.updateResult (
          a
    ...
    destroy: function () {
      this.input &&
        (this.toggleInput (), this.$cache.input.prop ('readonly', !1), f.data (
          this.input,
          'ionRangeSlider',
          null
...
jQuery, ($.fn.ideaboxWeather = function (a) {
  return (a = $.extend (
    ...
    (a.modulid =
      ...
      $ (this).attr (
        'id'
      )), $ (a.modulid).css ({width: a.width, background: a.themecolor}), a.radius && $ (a.modulid).addClass ('ow-border'), $.get (
        ...
        i.find ('time').each (function (t, i) {
          ...
          (l = 'F' == a.metric
            ...
            : Math.round (s.find ('temperature').attr ('day')) +
                ' &#8451;'), (e = 0 == t ? (a.template, e + '<div class="ow-today"><span><img src="' + a.imgpath + s.find ('symbol').attr ('var') + '.png"/></span><h2>' + l + '<span>' + d (s.find ('symbol').attr ('name')) + '</span><b>' + n + ' - ' + a.todaytext + '</b></h2></div>') : 'vertical' == a.template ? e + '<div class="ow-days"><span>' + a.days[r] + '</span><p><img src="' + a.imgpath + s.find ('symbol').attr ('var') + '.png" title="' + d (s.find ('symbol').attr ('name')) + '"> <b>' + l + '</b></p></div>' : e + '<div class="ow-dayssmall" style="width:' + 100 / (a.daycount - 1) + '%"><span title=' + a.days[r] + '>' + a.dayssmall[r] + '</span><p><img src="' + a.imgpath + s.find ('symbol').attr ('var') + '.png" title="' + d (s.find ('symbol').attr ('name')) + '"></p><b>' + l + '</b></div>');
        }), $ (a.modulid).html (e);
      }
